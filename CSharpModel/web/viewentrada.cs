...
namespace GeneXus.Programs {
   public class viewentrada : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewentrada( )
      {
      ...
      public viewentrada( IGxContext context )
      {
      ...
      public void execute( short aP0_EntradaId ,
                           string aP1_TabCode )
      {
         this.AV12EntradaId = aP0_EntradaId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12EntradaId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12EntradaId", StringUtil.LTrimStr( (decimal)(AV12EntradaId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vENTRADAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EntradaId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281012272873", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewentrada.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12EntradaId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"EntradaId","TabCode"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vENTRADAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12EntradaId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vENTRADAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EntradaId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewentrada.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12EntradaId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"EntradaId","TabCode"})  ;
      }
      ...
      protected void WB0L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Entrada Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewEntrada.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Entradas", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewEntrada.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewEntrada.htm");
            /* Div Control */
      ...
      protected void START0L2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Entrada", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0L2( )
      {
         ...
         {
            /* Using cursor H000L2 */
            pr_default.execute(0, new Object[] {AV12EntradaId});
      ...
      protected void STRUP0L0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12EntradaId = (short)(context.localUtil.CToN( cgiGet( "vENTRADAID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewentrada:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110L2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000L3 */
         pr_default.execute(1, new Object[] {AV12EntradaId});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "EntradaGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "entradageneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "EntradaGeneral";
               WebComp_Generalwc_Component = "EntradaGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12EntradaId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12EntradaId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12EntradaId", StringUtil.LTrimStr( (decimal)(AV12EntradaId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vENTRADAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EntradaId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281012272884", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewentrada.js", "?202281012272885", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      private short AV12EntradaId ;
      private short wcpOAV12EntradaId ;
   ...
   public class viewentrada__default : DataStoreHelperBase, IDataStoreHelper
   {
