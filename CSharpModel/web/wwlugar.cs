...
namespace GeneXus.Programs {
   public class wwlugar : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwlugar( )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11LugarName = GetPar( "LugarName");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11LugarName, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228111850479", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vLUGARNAME", AV11LugarName);
         /* Send saved values. */
      ...
      protected void WB1C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Lugars", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWLugar.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWLugar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavLugarname_Internalname, "Lugar Name", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavLugarname_Internalname, AV11LugarName, StringUtil.RTrim( context.localUtil.Format( AV11LugarName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavLugarname_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavLugarname_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWLugar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START1C2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Lugars", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Lugarname Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vLUGARNAME"), AV11LugarName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA1C2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavLugarname_Internalname;
      ...
      protected void RF1C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11LugarName = StringUtil.Concat( StringUtil.RTrim( AV11LugarName), "%", "");
            /* Using cursor H001C2 */
            pr_default.execute(0, new Object[] {lV11LugarName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A6PaisName = H001C2_A6PaisName[0];
               A3PaisId = H001C2_A3PaisId[0];
               A5LugarName = H001C2_A5LugarName[0];
               A4LugarId = H001C2_A4LugarId[0];
               A6PaisName = H001C2_A6PaisName[0];
               E141C2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_LUGARID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A4LugarId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11LugarName = StringUtil.Concat( StringUtil.RTrim( AV11LugarName), "%", "");
         /* Using cursor H001C3 */
         pr_default.execute(1, new Object[] {lV11LugarName});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11LugarName = GridState.FilterValues("Lugarname");
            AssignAttri("", false, "AV11LugarName", AV11LugarName);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("LugarName", AV11LugarName);
      }
      ...
      protected void STRUP1C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11LugarName = cgiGet( edtavLugarname_Internalname);
            AssignAttri("", false, "AV11LugarName", AV11LugarName);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228111850494", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwlugar.js", "?20228111850494", false, true);
         }
      ...
      protected void init_default_properties( )
      {
         ...
         edtavLugarname_Internalname = "vLUGARNAME";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavLugarname_Jsonclick = "";
         edtavLugarname_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11LugarName',fld:'vLUGARNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E141C2',iparms:[{av:'A4LugarId',fld:'LUGARID',pic:'ZZZ9',hsh:true},{av:'A3PaisId',fld:'PAISID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtLugarName_Link',ctrl:'LUGARNAME',prop:'Link'},{av:'edtPaisName_Link',ctrl:'PAISNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111C2',iparms:[{av:'A4LugarId',fld:'LUGARID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11LugarName',fld:'vLUGARNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11LugarName',fld:'vLUGARNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11LugarName',fld:'vLUGARNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11LugarName',fld:'vLUGARNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11LugarName = "";
         H001C2_A6PaisName = new string[] {""} ;
         H001C2_A3PaisId = new short[1] ;
         H001C2_A5LugarName = new string[] {""} ;
         H001C2_A4LugarId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwlugar__default(),
            new Object[][] {
                new Object[] {
               H001C2_A6PaisName, H001C2_A3PaisId, H001C2_A5LugarName, H001C2_A4LugarId
               }
               , new Object[] {
      ...
      private int edtavLugarname_Enabled ;
      ...
      private string edtavLugarname_Internalname ;
      private string edtavLugarname_Jsonclick ;
      ...
      private string AV11LugarName ;
      private string A5LugarName ;
      private string A6PaisName ;
      private string lV11LugarName ;
      ...
      private string[] H001C2_A6PaisName ;
      private short[] H001C2_A3PaisId ;
      private string[] H001C2_A5LugarName ;
      private short[] H001C2_A4LugarId ;
   ...
   public class wwlugar__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A5LugarName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[PaisName], T1.[PaisId], T1.[LugarName], T1.[LugarId]";
         sFromString = " FROM ([Lugar] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11LugarName)) )
         {
            AddWhere(sWhereString, "(T1.[LugarName] like @lV11LugarName)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[LugarName]";
                                             ...
                                             string A5LugarName )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Lugar] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11LugarName)) )
         {
            AddWhere(sWhereString, "(T1.[LugarName] like @lV11LugarName)");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11LugarName",GXType.NVarChar,40,0) ,
