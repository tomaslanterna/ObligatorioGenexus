...
namespace GeneXus.Programs {
   public class clienteventawc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public clienteventawc( )
      {
      ...
      public clienteventawc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Cliente Venta WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022882235356", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("clienteventawc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6ClienteId,4,0))}, new string[] {"ClienteId"}) +"\">") ;
      ...
      {
         return "ClienteVentaWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Cliente Venta WC" ;
      }
      ...
      protected void WB0G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "clienteventawc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ClienteVentaWC.htm");
      ...
      protected void START0G2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Cliente Venta WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF0G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A7TipoEspectaculoId = H000G2_A7TipoEspectaculoId[0];
               A9ClienteId = H000G2_A9ClienteId[0];
               AssignAttri(sPrefix, false, "A9ClienteId", StringUtil.LTrimStr( (decimal)(A9ClienteId), 4, 0));
               A35EspectaculoSectorPrecio = H000G2_A35EspectaculoSectorPrecio[0];
               A32EspectaculoSectorName = H000G2_A32EspectaculoSectorName[0];
               A31EspectaculoSectorId = H000G2_A31EspectaculoSectorId[0];
               A12ValorPorAsiento = H000G2_A12ValorPorAsiento[0];
               A8TipoEspectaculoName = H000G2_A8TipoEspectaculoName[0];
               A2EspectaculoName = H000G2_A2EspectaculoName[0];
               A1EspectaculoId = H000G2_A1EspectaculoId[0];
               A11VentaId = H000G2_A11VentaId[0];
               A7TipoEspectaculoId = H000G2_A7TipoEspectaculoId[0];
               A2EspectaculoName = H000G2_A2EspectaculoName[0];
               A8TipoEspectaculoName = H000G2_A8TipoEspectaculoName[0];
               A35EspectaculoSectorPrecio = H000G2_A35EspectaculoSectorPrecio[0];
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "clienteventawc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2022882235376", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("clienteventawc.js", "?2022882235376", false, true);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtEspectaculoSectorId_Internalname = sPrefix+"ESPECTACULOSECTORID_"+sGXsfl_20_idx;
         edtEspectaculoSectorName_Internalname = sPrefix+"ESPECTACULOSECTORNAME_"+sGXsfl_20_idx;
         edtEspectaculoSectorPrecio_Internalname = sPrefix+"ESPECTACULOSECTORPRECIO_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtEspectaculoSectorId_Internalname = sPrefix+"ESPECTACULOSECTORID_"+sGXsfl_20_fel_idx;
         edtEspectaculoSectorName_Internalname = sPrefix+"ESPECTACULOSECTORNAME_"+sGXsfl_20_fel_idx;
         edtEspectaculoSectorPrecio_Internalname = sPrefix+"ESPECTACULOSECTORPRECIO_"+sGXsfl_20_fel_idx;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130G2',iparms:[{av:'A11VentaId',fld:'VENTAID',pic:'ZZZ9',hsh:true},{av:'A1EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9'},{av:'A7TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtEspectaculoName_Link',ctrl:'ESPECTACULONAME',prop:'Link'},{av:'edtTipoEspectaculoName_Link',ctrl:'TIPOESPECTACULONAME',prop:'Link'},{av:'edtValorPorAsiento_Link',ctrl:'VALORPORASIENTO',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110G2',iparms:[{av:'A11VentaId',fld:'VENTAID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000G2_A7TipoEspectaculoId = new short[1] ;
         H000G2_A9ClienteId = new short[1] ;
         H000G2_A35EspectaculoSectorPrecio = new short[1] ;
         H000G2_A32EspectaculoSectorName = new string[] {""} ;
         H000G2_A31EspectaculoSectorId = new short[1] ;
         H000G2_A12ValorPorAsiento = new short[1] ;
         H000G2_A8TipoEspectaculoName = new string[] {""} ;
         H000G2_A2EspectaculoName = new string[] {""} ;
         H000G2_A1EspectaculoId = new short[1] ;
         H000G2_A11VentaId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.clienteventawc__default(),
            new Object[][] {
                new Object[] {
               H000G2_A7TipoEspectaculoId, H000G2_A9ClienteId, H000G2_A35EspectaculoSectorPrecio, H000G2_A32EspectaculoSectorName, H000G2_A31EspectaculoSectorId, H000G2_A12ValorPorAsiento, H000G2_A8TipoEspectaculoName, H000G2_A2EspectaculoName, H000G2_A1EspectaculoId, H000G2_A11VentaId
               }
               , new Object[] {
      ...
      private short[] H000G2_A7TipoEspectaculoId ;
      private short[] H000G2_A9ClienteId ;
      private short[] H000G2_A35EspectaculoSectorPrecio ;
      private string[] H000G2_A32EspectaculoSectorName ;
      private short[] H000G2_A31EspectaculoSectorId ;
      private short[] H000G2_A12ValorPorAsiento ;
      private string[] H000G2_A8TipoEspectaculoName ;
      private string[] H000G2_A2EspectaculoName ;
      private short[] H000G2_A1EspectaculoId ;
      private short[] H000G2_A11VentaId ;
   ...
   public class clienteventawc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000G2", "SELECT T2.[TipoEspectaculoId], T1.[ClienteId], T4.[EspectaculoSectorPrecio], T4.[EspectaculoSectorName], T1.[EspectaculoSectorId], T1.[ValorPorAsiento], T3.[TipoEspectaculoName], T2.[EspectaculoName], T1.[EspectaculoId], T1.[VentaId] FROM ((([Venta] T1 INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) INNER JOIN [TipoEspectaculo] T3 ON T3.[TipoEspectaculoId] = T2.[TipoEspectaculoId]) INNER JOIN [EspectaculoSector] T4 ON T4.[EspectaculoId] = T1.[EspectaculoId] AND T4.[EspectaculoSectorId] = T1.[EspectaculoSectorId]) WHERE T1.[ClienteId] = @AV6ClienteId ORDER BY T1.[ClienteId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000G3", "SELECT COUNT(*) FROM ((([Venta] T1 INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) INNER JOIN [TipoEspectaculo] T3 ON T3.[TipoEspectaculoId] = T2.[TipoEspectaculoId]) INNER JOIN [EspectaculoSector] T4 ON T4.[EspectaculoId] = T1.[EspectaculoId] AND T4.[EspectaculoSectorId] = T1.[EspectaculoSectorId]) WHERE T1.[ClienteId] = @AV6ClienteId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
