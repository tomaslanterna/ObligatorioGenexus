...
namespace GeneXus.Programs {
   public class notauthorized : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022882193226", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_4_0B2( true) ;
         }
         else
         {
            wb_table1_4_0B2( false) ;
         }
         return  ;
      }

      protected void wb_table1_4_0B2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_13_0B2( true) ;
         }
         else
         {
            wb_table2_13_0B2( false) ;
         }
         return  ;
      }

      protected void wb_table2_13_0B2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_16_0B2( true) ;
         }
         else
         {
            wb_table3_16_0B2( false) ;
         }
         return  ;
      }

      protected void wb_table3_16_0B2e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void wb_table3_16_0B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_16_0B2e( true) ;
         }
         else
         {
            wb_table3_16_0B2e( false) ;
         }
      }

      protected void wb_table2_13_0B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_13_0B2e( true) ;
         }
         else
         {
            wb_table2_13_0B2e( false) ;
         }
      }

      protected void wb_table1_4_0B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_4_0B2e( true) ;
         }
         else
         {
            wb_table1_4_0B2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2022882193231", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("notauthorized.js", "?2022882193231", false, true);
