...
namespace GeneXus.Programs {
   public class wwventa : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV15ValorPorAsiento = (short)(NumberUtil.Val( GetPar( "ValorPorAsiento"), "."));
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV15ValorPorAsiento, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228822543840", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vVALORPORASIENTO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15ValorPorAsiento), 4, 0, ",", "")));
         /* Send saved values. */
      ...
      protected void WB0J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Ventas", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWVenta.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWVenta.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavValorporasiento_Internalname, "Valor Por Asiento", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavValorporasiento_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15ValorPorAsiento), 4, 0, ",", "")), StringUtil.LTrim( ((edtavValorporasiento_Enabled!=0) ? context.localUtil.Format( (decimal)(AV15ValorPorAsiento), "ZZZ9") : context.localUtil.Format( (decimal)(AV15ValorPorAsiento), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Por Asiento", edtavValorporasiento_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavValorporasiento_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WWVenta.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Valorporasiento Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vVALORPORASIENTO"), ",", ".") != Convert.ToDecimal( AV15ValorPorAsiento )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0J2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavValorporasiento_Internalname;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_VENTAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A11VentaId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "VENTAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A11VentaId), 4, 0, ".", "")));
      }
      ...
      protected void RF0J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000J2 */
            pr_default.execute(0, new Object[] {AV15ValorPorAsiento, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A4LugarId = H000J2_A4LugarId[0];
               A7TipoEspectaculoId = H000J2_A7TipoEspectaculoId[0];
               A31EspectaculoSectorId = H000J2_A31EspectaculoSectorId[0];
               A35EspectaculoSectorPrecio = H000J2_A35EspectaculoSectorPrecio[0];
               A32EspectaculoSectorName = H000J2_A32EspectaculoSectorName[0];
               A10ClienteName = H000J2_A10ClienteName[0];
               A9ClienteId = H000J2_A9ClienteId[0];
               A6PaisName = H000J2_A6PaisName[0];
               A3PaisId = H000J2_A3PaisId[0];
               A12ValorPorAsiento = H000J2_A12ValorPorAsiento[0];
               A8TipoEspectaculoName = H000J2_A8TipoEspectaculoName[0];
               A2EspectaculoName = H000J2_A2EspectaculoName[0];
               A1EspectaculoId = H000J2_A1EspectaculoId[0];
               A11VentaId = H000J2_A11VentaId[0];
               A10ClienteName = H000J2_A10ClienteName[0];
               A4LugarId = H000J2_A4LugarId[0];
               A7TipoEspectaculoId = H000J2_A7TipoEspectaculoId[0];
               A2EspectaculoName = H000J2_A2EspectaculoName[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_VENTAID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A11VentaId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H000J3 */
         pr_default.execute(1, new Object[] {AV15ValorPorAsiento});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV15ValorPorAsiento = (short)(NumberUtil.Val( GridState.FilterValues("Valorporasiento"), "."));
            AssignAttri("", false, "AV15ValorPorAsiento", StringUtil.LTrimStr( (decimal)(AV15ValorPorAsiento), 4, 0));
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("ValorPorAsiento", StringUtil.Str( (decimal)(AV15ValorPorAsiento), 4, 0));
      }
      ...
      protected void STRUP0J0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavValorporasiento_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavValorporasiento_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vVALORPORASIENTO");
               GX_FocusControl = edtavValorporasiento_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV15ValorPorAsiento = 0;
               AssignAttri("", false, "AV15ValorPorAsiento", StringUtil.LTrimStr( (decimal)(AV15ValorPorAsiento), 4, 0));
            }
            else
            {
               AV15ValorPorAsiento = (short)(context.localUtil.CToN( cgiGet( edtavValorporasiento_Internalname), ",", "."));
               AssignAttri("", false, "AV15ValorPorAsiento", StringUtil.LTrimStr( (decimal)(AV15ValorPorAsiento), 4, 0));
            }
      ...
      private void E140J2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("venta.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A11VentaId,4,0))}, new string[] {"Mode","VentaId"}) ;
         edtavDelete_Link = formatLink("venta.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A11VentaId,4,0))}, new string[] {"Mode","VentaId"}) ;
         ...
         edtValorPorAsiento_Link = formatLink("viewventa.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A11VentaId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"VentaId","TabCode"}) ;
      ...
      protected void E110J2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("venta.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","VentaId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228822543860", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwventa.js", "?20228822543860", false, true);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtValorPorAsiento_Internalname = "VALORPORASIENTO_"+sGXsfl_25_idx;
         ...
         edtEspectaculoSectorName_Internalname = "ESPECTACULOSECTORNAME_"+sGXsfl_25_idx;
         edtEspectaculoSectorPrecio_Internalname = "ESPECTACULOSECTORPRECIO_"+sGXsfl_25_idx;
         edtEspectaculoSectorId_Internalname = "ESPECTACULOSECTORID_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtValorPorAsiento_Internalname = "VALORPORASIENTO_"+sGXsfl_25_fel_idx;
         ...
         edtEspectaculoSectorName_Internalname = "ESPECTACULOSECTORNAME_"+sGXsfl_25_fel_idx;
         edtEspectaculoSectorPrecio_Internalname = "ESPECTACULOSECTORPRECIO_"+sGXsfl_25_fel_idx;
         edtEspectaculoSectorId_Internalname = "ESPECTACULOSECTORID_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtValorPorAsiento_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A12ValorPorAsiento), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A12ValorPorAsiento), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtValorPorAsiento_Link,(string)"",(string)"",(string)"",(string)edtValorPorAsiento_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEspectaculoSectorId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A31EspectaculoSectorId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A31EspectaculoSectorId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEspectaculoSectorId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl25( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Por Asiento") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Espectaculo Sector Name") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Espectaculo Sector Precio") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Espectaculo Sector Id") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A11VentaId), 4, 0, ".", "")));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A12ValorPorAsiento), 4, 0, ".", "")));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtValorPorAsiento_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", A32EspectaculoSectorName);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A35EspectaculoSectorPrecio), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A31EspectaculoSectorId), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavValorporasiento_Internalname = "vVALORPORASIENTO";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavValorporasiento_Jsonclick = "";
         edtavValorporasiento_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15ValorPorAsiento',fld:'vVALORPORASIENTO',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140J2',iparms:[{av:'A11VentaId',fld:'VENTAID',pic:'ZZZ9',hsh:true},{av:'A1EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9'},{av:'A7TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9'},{av:'A3PaisId',fld:'PAISID',pic:'ZZZ9'},{av:'A9ClienteId',fld:'CLIENTEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtEspectaculoName_Link',ctrl:'ESPECTACULONAME',prop:'Link'},{av:'edtTipoEspectaculoName_Link',ctrl:'TIPOESPECTACULONAME',prop:'Link'},{av:'edtValorPorAsiento_Link',ctrl:'VALORPORASIENTO',prop:'Link'},{av:'edtPaisName_Link',ctrl:'PAISNAME',prop:'Link'},{av:'edtClienteName_Link',ctrl:'CLIENTENAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110J2',iparms:[{av:'A11VentaId',fld:'VENTAID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15ValorPorAsiento',fld:'vVALORPORASIENTO',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15ValorPorAsiento',fld:'vVALORPORASIENTO',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15ValorPorAsiento',fld:'vVALORPORASIENTO',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15ValorPorAsiento',fld:'vVALORPORASIENTO',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV18Pgmname = "";
         scmdbuf = "";
         H000J2_A4LugarId = new short[1] ;
         H000J2_A7TipoEspectaculoId = new short[1] ;
         H000J2_A31EspectaculoSectorId = new short[1] ;
         H000J2_A35EspectaculoSectorPrecio = new short[1] ;
         H000J2_A32EspectaculoSectorName = new string[] {""} ;
         H000J2_A10ClienteName = new string[] {""} ;
         H000J2_A9ClienteId = new short[1] ;
         H000J2_A6PaisName = new string[] {""} ;
         H000J2_A3PaisId = new short[1] ;
         H000J2_A12ValorPorAsiento = new short[1] ;
         H000J2_A8TipoEspectaculoName = new string[] {""} ;
         H000J2_A2EspectaculoName = new string[] {""} ;
         H000J2_A1EspectaculoId = new short[1] ;
         H000J2_A11VentaId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwventa__default(),
            new Object[][] {
                new Object[] {
               H000J2_A4LugarId, H000J2_A7TipoEspectaculoId, H000J2_A31EspectaculoSectorId, H000J2_A35EspectaculoSectorPrecio, H000J2_A32EspectaculoSectorName, H000J2_A10ClienteName, H000J2_A9ClienteId, H000J2_A6PaisName, H000J2_A3PaisId, H000J2_A12ValorPorAsiento,
               H000J2_A8TipoEspectaculoName, H000J2_A2EspectaculoName, H000J2_A1EspectaculoId, H000J2_A11VentaId
               }
               , new Object[] {
      ...
      private short AV15ValorPorAsiento ;
      ...
      private int edtavValorporasiento_Enabled ;
      ...
      private string edtavValorporasiento_Internalname ;
      private string edtavValorporasiento_Jsonclick ;
      ...
      private string edtValorPorAsiento_Link ;
      ...
      private short[] H000J2_A4LugarId ;
      private short[] H000J2_A7TipoEspectaculoId ;
      private short[] H000J2_A31EspectaculoSectorId ;
      private short[] H000J2_A35EspectaculoSectorPrecio ;
      private string[] H000J2_A32EspectaculoSectorName ;
      private string[] H000J2_A10ClienteName ;
      private short[] H000J2_A9ClienteId ;
      private string[] H000J2_A6PaisName ;
      private short[] H000J2_A3PaisId ;
      private short[] H000J2_A12ValorPorAsiento ;
      private string[] H000J2_A8TipoEspectaculoName ;
      private string[] H000J2_A2EspectaculoName ;
      private short[] H000J2_A1EspectaculoId ;
      private short[] H000J2_A11VentaId ;
   ...
   public class wwventa__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A12ValorPorAsiento )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T3.[LugarId], T3.[TipoEspectaculoId], T1.[EspectaculoSectorId], T7.[EspectaculoSectorPrecio], T7.[EspectaculoSectorName], T2.[ClienteName], T1.[ClienteId], T5.[PaisName], T4.[PaisId], T1.[ValorPorAsiento], T6.[TipoEspectaculoName], T3.[EspectaculoName], T1.[EspectaculoId], T1.[VentaId]";
         sFromString = " FROM (((((([Venta] T1 INNER JOIN [Cliente] T2 ON T2.[ClienteId] = T1.[ClienteId]) INNER JOIN [Espectaculo] T3 ON T3.[EspectaculoId] = T1.[EspectaculoId]) INNER JOIN [Lugar] T4 ON T4.[LugarId] = T3.[LugarId]) INNER JOIN [Pais] T5 ON T5.[PaisId] = T4.[PaisId]) INNER JOIN [TipoEspectaculo] T6 ON T6.[TipoEspectaculoId] = T3.[TipoEspectaculoId]) INNER JOIN [EspectaculoSector] T7 ON T7.[EspectaculoId] = T1.[EspectaculoId] AND T7.[EspectaculoSectorId] = T1.[EspectaculoSectorId])";
         sOrderString = "";
         if ( ! (0==AV15ValorPorAsiento) )
         {
            AddWhere(sWhereString, "(T1.[ValorPorAsiento] >= @AV15ValorPorAsiento)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[ValorPorAsiento]";
                                             ...
                                             short A12ValorPorAsiento )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (((((([Venta] T1 INNER JOIN [Cliente] T6 ON T6.[ClienteId] = T1.[ClienteId]) INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) INNER JOIN [Lugar] T3 ON T3.[LugarId] = T2.[LugarId]) INNER JOIN [Pais] T7 ON T7.[PaisId] = T3.[PaisId]) INNER JOIN [TipoEspectaculo] T4 ON T4.[TipoEspectaculoId] = T2.[TipoEspectaculoId]) INNER JOIN [EspectaculoSector] T5 ON T5.[EspectaculoId] = T1.[EspectaculoId] AND T5.[EspectaculoSectorId] = T1.[EspectaculoSectorId])";
         if ( ! (0==AV15ValorPorAsiento) )
         {
            AddWhere(sWhereString, "(T1.[ValorPorAsiento] >= @AV15ValorPorAsiento)");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000J2(context, (short)dynConstraints[0] , (short)dynConstraints[1] );
               case 1 :
                     return conditional_H000J3(context, (short)dynConstraints[0] , (short)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV15ValorPorAsiento",GXType.Int16,4,0) ,
