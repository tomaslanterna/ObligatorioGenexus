...
namespace GeneXus.Programs {
   public class viewlugar : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewlugar( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12LugarId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228822352519", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("LugarName", StringUtil.RTrim( context.localUtil.Format( A5LugarName, "")));
      ...
      protected void WB1B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Lugar Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewLugar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Lugars", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewLugar.htm");
            ...
            GxWebStd.gx_label_element( context, edtLugarName_Internalname, "Name", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtLugarName_Internalname, A5LugarName, StringUtil.RTrim( context.localUtil.Format( A5LugarName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLugarName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtLugarName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_ViewLugar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSector_title_Internalname, "Sector", "", "", lblSector_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewLugar.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0046"+"", StringUtil.RTrim( WebComp_Espectaculowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 46 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Espectaculowc_Component) != 0 )
                           {
                              WebComp_Espectaculowc.componentprocess("W0046", "", sEvt);
                           }
                           WebComp_Espectaculowc_Component = OldEspectaculowc;
                        }
                     }
      ...
      protected void RF1B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A4LugarId = H001B2_A4LugarId[0];
               A5LugarName = H001B2_A5LugarName[0];
      ...
      protected void STRUP1B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12LugarId = (short)(context.localUtil.CToN( cgiGet( "vLUGARID"), ",", "."));
      ...
      protected void E111B2( )
      {
         ...
         {
            A4LugarId = H001B3_A4LugarId[0];
            A5LugarName = H001B3_A5LugarName[0];
            AssignAttri("", false, "A5LugarName", A5LugarName);
            AV16GXLvl6 = 1;
            Form.Caption = A5LugarName;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12LugarId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Sector") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Sectorwc_Component), StringUtil.Lower( "LugarSectorWC")) != 0 )
            {
               WebComp_Sectorwc = getWebComponent(GetType(), "GeneXus.Programs", "lugarsectorwc", new Object[] {context} );
               WebComp_Sectorwc.ComponentInit();
               WebComp_Sectorwc.Name = "LugarSectorWC";
               WebComp_Sectorwc_Component = "LugarSectorWC";
            }
            if ( StringUtil.Len( WebComp_Sectorwc_Component) != 0 )
            {
               WebComp_Sectorwc.setjustcreated();
               WebComp_Sectorwc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12LugarId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Espectaculo") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Espectaculowc_Component) != 0 )
            {
               ...
               WebComp_Espectaculowc.componentprepare(new Object[] {(string)"W0046",(string)"",(short)AV12LugarId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228822352532", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewlugar.js", "?20228822352532", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12LugarId',fld:'vLUGARID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A5LugarName',fld:'LUGARNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H001B2_A4LugarId = new short[1] ;
         H001B2_A5LugarName = new string[] {""} ;
         hsh = "";
         H001B3_A4LugarId = new short[1] ;
         H001B3_A5LugarName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewlugar__default(),
            new Object[][] {
                new Object[] {
               H001B2_A4LugarId, H001B2_A5LugarName
               }
               , new Object[] {
               H001B3_A4LugarId, H001B3_A5LugarName
               }
            }
         );
      ...
      private short[] H001B2_A4LugarId ;
      private string[] H001B2_A5LugarName ;
      private short[] H001B3_A4LugarId ;
      private string[] H001B3_A5LugarName ;
   ...
   public class viewlugar__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001B2", "SELECT [LugarId], [LugarName] FROM [Lugar] WHERE [LugarId] = @AV12LugarId ORDER BY [LugarId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001B3", "SELECT [LugarId], [LugarName] FROM [Lugar] WHERE [LugarId] = @AV12LugarId ORDER BY [LugarId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
