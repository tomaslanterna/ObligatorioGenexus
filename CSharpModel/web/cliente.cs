...
namespace GeneXus.Programs {
   public class cliente : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITTRN( )
      {
         ...
         {
            GX_FocusControl = edtClienteName_Internalname;
      ...
      protected void DrawControls( )
      {
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_select_Internalname, "", "Seleccionar", bttBtn_select_Jsonclick, 5, "Seleccionar", "", StyleString, ClassString, bttBtn_select_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"ESELECT."+"'", TempTags, "", 2, "HLP_Cliente.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtClienteId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A9ClienteId), 4, 0, ",", "")), StringUtil.LTrim( ((edtClienteId_Enabled!=0) ? context.localUtil.Format( (decimal)(A9ClienteId), "ZZZ9") : context.localUtil.Format( (decimal)(A9ClienteId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClienteId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtClienteId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_Cliente.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtClienteName_Internalname, "Name", "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 39,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtClienteName_Internalname, A10ClienteName, StringUtil.RTrim( context.localUtil.Format( A10ClienteName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClienteName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtClienteName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_Cliente.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_bitmap( context, imgprompt_3_Internalname, sImgUrl, imgprompt_3_Link, "", "", context.GetTheme( ), imgprompt_3_Visible, 1, "", "", 0, 0, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Cliente.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtPaisName_Internalname, A6PaisName, StringUtil.RTrim( context.localUtil.Format( A6PaisName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPaisName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_Cliente.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, bttBtn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Cliente.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z10ClienteName = cgiGet( "Z10ClienteName");
      ...
      protected void ZM055( short GX_JID )
      {
         if ( ( GX_JID == 9 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z10ClienteName = T00053_A10ClienteName[0];
               Z3PaisId = T00053_A3PaisId[0];
            }
            else
            {
      ...
      protected void standaloneModal( )
      {
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ( Gx_BScreen == 0 ) )
         {
            ...
            A6PaisName = T00054_A6PaisName[0];
            AssignAttri("", false, "A6PaisName", A6PaisName);
            pr_default.close(2);
         }
      }
      ...
      protected void Load055( )
      {
         ...
         {
            RcdFound5 = 1;
            A10ClienteName = T00055_A10ClienteName[0];
            AssignAttri("", false, "A10ClienteName", A10ClienteName);
            A6PaisName = T00055_A6PaisName[0];
            AssignAttri("", false, "A6PaisName", A6PaisName);
            A3PaisId = T00055_A3PaisId[0];
            AssignAttri("", false, "A3PaisId", StringUtil.LTrimStr( (decimal)(A3PaisId), 4, 0));
            ZM055( -9) ;
         }
         pr_default.close(3);
      ...
      protected void CheckExtendedTable055( )
      {
         ...
         {
            GX_msglist.addItem("Se debe ingresar un nombre", 1, "CLIENTENAME");
            AnyError = 1;
            GX_FocusControl = edtClienteName_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      protected void gxLoad_10( short A3PaisId )
      {
         /* Using cursor T00056 */
         ...
         A6PaisName = T00056_A6PaisName[0];
         AssignAttri("", false, "A6PaisName", A6PaisName);
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignAttri("", false, "A9ClienteId", StringUtil.LTrimStr( (decimal)(A9ClienteId), 4, 0));
            A10ClienteName = T00053_A10ClienteName[0];
            AssignAttri("", false, "A10ClienteName", A10ClienteName);
            A3PaisId = T00053_A3PaisId[0];
            AssignAttri("", false, "A3PaisId", StringUtil.LTrimStr( (decimal)(A3PaisId), 4, 0));
            Z9ClienteId = A9ClienteId;
            sMode5 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         ...
         {
            while ( (pr_default.getStatus(6) != 101) && ( ( T00058_A9ClienteId[0] < A9ClienteId ) ) )
            {
               pr_default.readNext(6);
            }
            if ( (pr_default.getStatus(6) != 101) && ( ( T00058_A9ClienteId[0] > A9ClienteId ) ) )
            {
               A9ClienteId = T00058_A9ClienteId[0];
               AssignAttri("", false, "A9ClienteId", StringUtil.LTrimStr( (decimal)(A9ClienteId), 4, 0));
               RcdFound5 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(7) != 101) && ( ( T00059_A9ClienteId[0] > A9ClienteId ) ) )
            {
               pr_default.readNext(7);
            }
            if ( (pr_default.getStatus(7) != 101) && ( ( T00059_A9ClienteId[0] < A9ClienteId ) ) )
            {
               A9ClienteId = T00059_A9ClienteId[0];
               AssignAttri("", false, "A9ClienteId", StringUtil.LTrimStr( (decimal)(A9ClienteId), 4, 0));
               RcdFound5 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency055( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z10ClienteName, T00052_A10ClienteName[0]) != 0 ) || ( Z3PaisId != T00052_A3PaisId[0] ) )
            {
               if ( StringUtil.StrCmp(Z10ClienteName, T00052_A10ClienteName[0]) != 0 )
               {
                  GXUtil.WriteLog("cliente:[seudo value changed for attri]"+"ClienteName");
                  GXUtil.WriteLogRaw("Old: ",Z10ClienteName);
                  GXUtil.WriteLogRaw("Current: ",T00052_A10ClienteName[0]);
               }
               if ( Z3PaisId != T00052_A3PaisId[0] )
               {
                  GXUtil.WriteLog("cliente:[seudo value changed for attri]"+"PaisId");
                  GXUtil.WriteLogRaw("Old: ",Z3PaisId);
                  GXUtil.WriteLogRaw("Current: ",T00052_A3PaisId[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {A10ClienteName, A3PaisId});
                     A9ClienteId = T000510_A9ClienteId[0];
                     AssignAttri("", false, "A9ClienteId", StringUtil.LTrimStr( (decimal)(A9ClienteId), 4, 0));
                     pr_default.close(8);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(9, new Object[] {A10ClienteName, A3PaisId, A9ClienteId});
                     pr_default.close(9);
                     dsDefault.SmartCacheProvider.SetUpdated("Cliente");
      ...
      protected void OnDeleteControls055( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            A6PaisName = T000513_A6PaisName[0];
            AssignAttri("", false, "A6PaisName", A6PaisName);
            pr_default.close(11);
         }
         if ( AnyError == 0 )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281012272464", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z10ClienteName", Z10ClienteName);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281012272468", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("cliente.js", "?202281012272468", false, true);
      ...
      {
         setEventMetadata("ENTER","{handler:'UserMainFullajax',iparms:[{postForm:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV7ClienteId',fld:'vCLIENTEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[]}");
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV9TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'AV7ClienteId',fld:'vCLIENTEID',pic:'ZZZ9',hsh:true},{av:'A9ClienteId',fld:'CLIENTEID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("VALID_CLIENTENAME","{handler:'Valid_Clientename',iparms:[]");
         setEventMetadata("VALID_CLIENTENAME",",oparms:[]}");
      ...
      public override void initialize( )
      {
         ...
         Z6PaisName = "";
         T00054_A6PaisName = new string[] {""} ;
         T00055_A9ClienteId = new short[1] ;
         T00055_A10ClienteName = new string[] {""} ;
         T00055_A6PaisName = new string[] {""} ;
         T00055_A3PaisId = new short[1] ;
         T00056_A6PaisName = new string[] {""} ;
         T00057_A9ClienteId = new short[1] ;
         T00053_A9ClienteId = new short[1] ;
         T00053_A10ClienteName = new string[] {""} ;
         T00053_A3PaisId = new short[1] ;
         T00058_A9ClienteId = new short[1] ;
         T00059_A9ClienteId = new short[1] ;
         T00052_A9ClienteId = new short[1] ;
         T00052_A10ClienteName = new string[] {""} ;
         T00052_A3PaisId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.cliente__default(),
            new Object[][] {
                new Object[] {
               T00052_A9ClienteId, T00052_A10ClienteName, T00052_A3PaisId
               }
               , new Object[] {
               T00053_A9ClienteId, T00053_A10ClienteName, T00053_A3PaisId
               }
               , new Object[] {
               T00054_A6PaisName
               }
               , new Object[] {
               T00055_A9ClienteId, T00055_A10ClienteName, T00055_A6PaisName, T00055_A3PaisId
               }
               , new Object[] {
               T00056_A6PaisName
               }
      ...
      private string[] T00054_A6PaisName ;
      private short[] T00055_A9ClienteId ;
      private string[] T00055_A10ClienteName ;
      private string[] T00055_A6PaisName ;
      private short[] T00055_A3PaisId ;
      private string[] T00056_A6PaisName ;
      private short[] T00057_A9ClienteId ;
      private short[] T00053_A9ClienteId ;
      private string[] T00053_A10ClienteName ;
      private short[] T00053_A3PaisId ;
      private short[] T00058_A9ClienteId ;
      private short[] T00059_A9ClienteId ;
      private short[] T00052_A9ClienteId ;
      private string[] T00052_A10ClienteName ;
      private short[] T00052_A3PaisId ;
   ...
   public class cliente__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("T00052", "SELECT [ClienteId], [ClienteName], [PaisId] FROM [Cliente] WITH (UPDLOCK) WHERE [ClienteId] = @ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00052,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00053", "SELECT [ClienteId], [ClienteName], [PaisId] FROM [Cliente] WHERE [ClienteId] = @ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00053,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00054", "SELECT [PaisName] FROM [Pais] WHERE [PaisId] = @PaisId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00054,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00055", "SELECT TM1.[ClienteId], TM1.[ClienteName], T2.[PaisName], TM1.[PaisId] FROM ([Cliente] TM1 INNER JOIN [Pais] T2 ON T2.[PaisId] = TM1.[PaisId]) WHERE TM1.[ClienteId] = @ClienteId ORDER BY TM1.[ClienteId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT00055,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00056", "SELECT [PaisName] FROM [Pais] WHERE [PaisId] = @PaisId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00056,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00057", "SELECT [ClienteId] FROM [Cliente] WHERE [ClienteId] = @ClienteId  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT00057,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00058", "SELECT TOP 1 [ClienteId] FROM [Cliente] WHERE ( [ClienteId] > @ClienteId) ORDER BY [ClienteId]  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT00058,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T00059", "SELECT TOP 1 [ClienteId] FROM [Cliente] WHERE ( [ClienteId] < @ClienteId) ORDER BY [ClienteId] DESC  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT00059,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000510", "INSERT INTO [Cliente]([ClienteName], [PaisId]) VALUES(@ClienteName, @PaisId); SELECT SCOPE_IDENTITY()",true, GxErrorMask.GX_NOMASK, false, this,prmT000510,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000511", "UPDATE [Cliente] SET [ClienteName]=@ClienteName, [PaisId]=@PaisId  WHERE [ClienteId] = @ClienteId", GxErrorMask.GX_NOMASK,prmT000511)
