...
namespace GeneXus.Programs {
   public class viewinvitacion : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12InvitacionId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228822352466", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("InvitacionFecha", context.localUtil.Format(A25InvitacionFecha, "99/99/99"));
      ...
      protected void WB180( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Invitacion Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewInvitacion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Invitacions", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewInvitacion.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtInvitacionFecha_Internalname, context.localUtil.Format(A25InvitacionFecha, "99/99/99"), context.localUtil.Format( A25InvitacionFecha, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtInvitacionFecha_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtInvitacionFecha_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ViewInvitacion.htm");
            GxWebStd.gx_bitmap( context, edtInvitacionFecha_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtInvitacionFecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewInvitacion.htm");
      ...
      protected void RF182( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A24InvitacionId = H00182_A24InvitacionId[0];
               A25InvitacionFecha = H00182_A25InvitacionFecha[0];
      ...
      protected void STRUP180( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12InvitacionId = (short)(context.localUtil.CToN( cgiGet( "vINVITACIONID"), ",", "."));
      ...
      protected void E11182( )
      {
         ...
         {
            A24InvitacionId = H00183_A24InvitacionId[0];
            A25InvitacionFecha = H00183_A25InvitacionFecha[0];
            AssignAttri("", false, "A25InvitacionFecha", context.localUtil.Format(A25InvitacionFecha, "99/99/99"));
            AV16GXLvl6 = 1;
            Form.Caption = context.localUtil.DToC( A25InvitacionFecha, 2, "/");
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12InvitacionId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228822352475", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewinvitacion.js", "?20228822352475", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12InvitacionId',fld:'vINVITACIONID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A25InvitacionFecha',fld:'INVITACIONFECHA',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00182_A24InvitacionId = new short[1] ;
         H00182_A25InvitacionFecha = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H00183_A24InvitacionId = new short[1] ;
         H00183_A25InvitacionFecha = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewinvitacion__default(),
            new Object[][] {
                new Object[] {
               H00182_A24InvitacionId, H00182_A25InvitacionFecha
               }
               , new Object[] {
               H00183_A24InvitacionId, H00183_A25InvitacionFecha
               }
            }
         );
      ...
      private short[] H00182_A24InvitacionId ;
      private DateTime[] H00182_A25InvitacionFecha ;
      private short[] H00183_A24InvitacionId ;
      private DateTime[] H00183_A25InvitacionFecha ;
   ...
   public class viewinvitacion__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00182", "SELECT [InvitacionId], [InvitacionFecha] FROM [Invitacion] WHERE [InvitacionId] = @AV12InvitacionId ORDER BY [InvitacionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00182,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00183", "SELECT [InvitacionId], [InvitacionFecha] FROM [Invitacion] WHERE [InvitacionId] = @AV12InvitacionId ORDER BY [InvitacionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00183,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
