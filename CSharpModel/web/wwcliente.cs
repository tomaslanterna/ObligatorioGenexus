...
namespace GeneXus.Programs {
   public class wwcliente : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwcliente( )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11ClienteName = GetPar( "ClienteName");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11ClienteName, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281118495943", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCLIENTENAME", AV11ClienteName);
         /* Send saved values. */
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Clientes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWCliente.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavClientename_Internalname, "Cliente Name", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavClientename_Internalname, AV11ClienteName, StringUtil.RTrim( context.localUtil.Format( AV11ClienteName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavClientename_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavClientename_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Clientename Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCLIENTENAME"), AV11ClienteName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0E2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavClientename_Internalname;
      ...
      protected void RF0E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11ClienteName = StringUtil.Concat( StringUtil.RTrim( AV11ClienteName), "%", "");
            /* Using cursor H000E2 */
            pr_default.execute(0, new Object[] {lV11ClienteName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A6PaisName = H000E2_A6PaisName[0];
               A3PaisId = H000E2_A3PaisId[0];
               A10ClienteName = H000E2_A10ClienteName[0];
               A9ClienteId = H000E2_A9ClienteId[0];
               A6PaisName = H000E2_A6PaisName[0];
               E140E2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CLIENTEID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A9ClienteId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11ClienteName = StringUtil.Concat( StringUtil.RTrim( AV11ClienteName), "%", "");
         /* Using cursor H000E3 */
         pr_default.execute(1, new Object[] {lV11ClienteName});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11ClienteName = GridState.FilterValues("Clientename");
            AssignAttri("", false, "AV11ClienteName", AV11ClienteName);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("ClienteName", AV11ClienteName);
      }
      ...
      protected void STRUP0E0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11ClienteName = cgiGet( edtavClientename_Internalname);
            AssignAttri("", false, "AV11ClienteName", AV11ClienteName);
      ...
      private void E140E2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("cliente.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A9ClienteId,4,0))}, new string[] {"Mode","ClienteId"}) ;
         edtavDelete_Link = formatLink("cliente.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A9ClienteId,4,0))}, new string[] {"Mode","ClienteId"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281118495960", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcliente.js", "?202281118495960", false, true);
         }
      ...
      protected void init_default_properties( )
      {
         ...
         edtavClientename_Internalname = "vCLIENTENAME";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavClientename_Jsonclick = "";
         edtavClientename_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ClienteName',fld:'vCLIENTENAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140E2',iparms:[{av:'A9ClienteId',fld:'CLIENTEID',pic:'ZZZ9',hsh:true},{av:'A3PaisId',fld:'PAISID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtClienteName_Link',ctrl:'CLIENTENAME',prop:'Link'},{av:'edtPaisName_Link',ctrl:'PAISNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110E2',iparms:[{av:'A9ClienteId',fld:'CLIENTEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ClienteName',fld:'vCLIENTENAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ClienteName',fld:'vCLIENTENAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ClienteName',fld:'vCLIENTENAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11ClienteName',fld:'vCLIENTENAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11ClienteName = "";
         H000E2_A6PaisName = new string[] {""} ;
         H000E2_A3PaisId = new short[1] ;
         H000E2_A10ClienteName = new string[] {""} ;
         H000E2_A9ClienteId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwcliente__default(),
            new Object[][] {
                new Object[] {
               H000E2_A6PaisName, H000E2_A3PaisId, H000E2_A10ClienteName, H000E2_A9ClienteId
               }
               , new Object[] {
      ...
      private int edtavClientename_Enabled ;
      ...
      private string edtavClientename_Internalname ;
      private string edtavClientename_Jsonclick ;
      ...
      private string AV11ClienteName ;
      private string A10ClienteName ;
      private string A6PaisName ;
      private string lV11ClienteName ;
      ...
      private string[] H000E2_A6PaisName ;
      private short[] H000E2_A3PaisId ;
      private string[] H000E2_A10ClienteName ;
      private short[] H000E2_A9ClienteId ;
   ...
   public class wwcliente__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A10ClienteName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[PaisName], T1.[PaisId], T1.[ClienteName], T1.[ClienteId]";
         sFromString = " FROM ([Cliente] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11ClienteName)) )
         {
            AddWhere(sWhereString, "(T1.[ClienteName] like @lV11ClienteName)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[ClienteName]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11ClienteName",GXType.NVarChar,40,0) ,
