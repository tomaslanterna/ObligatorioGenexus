...
namespace GeneXus.Programs {
   public class wwinvitacion : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwinvitacion( )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11InvitacionFecha = context.localUtil.ParseDateParm( GetPar( "InvitacionFecha"));
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11InvitacionFecha, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228111850437", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vINVITACIONFECHA", context.localUtil.Format(AV11InvitacionFecha, "99/99/99"));
         /* Send saved values. */
      ...
      protected void WB190( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Invitacions", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWInvitacion.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWInvitacion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavInvitacionfecha_Internalname, "Invitacion Fecha", "col-sm-3 DateFilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            context.WriteHtmlText( "<div id=\""+edtavInvitacionfecha_Internalname+"_dp_container\" class=\"dp_container\" style=\"white-space:nowrap;display:inline;\">") ;
            GxWebStd.gx_single_line_edit( context, edtavInvitacionfecha_Internalname, context.localUtil.Format(AV11InvitacionFecha, "99/99/99"), context.localUtil.Format( AV11InvitacionFecha, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavInvitacionfecha_Jsonclick, 0, "DateFilterSearchAttribute", "", "", "", "", 1, edtavInvitacionfecha_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WWInvitacion.htm");
            GxWebStd.gx_bitmap( context, edtavInvitacionfecha_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavInvitacionfecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WWInvitacion.htm");
      ...
      protected void START192( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Invitacions", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A25InvitacionFecha = DateTimeUtil.ResetTime(context.localUtil.CToT( cgiGet( edtInvitacionFecha_Internalname), 0));
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Invitacionfecha Changed */
                                       if ( context.localUtil.CToT( cgiGet( "GXH_vINVITACIONFECHA"), 0) != AV11InvitacionFecha )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA192( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavInvitacionfecha_Internalname;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_INVITACIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A24InvitacionId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "INVITACIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A24InvitacionId), 4, 0, ".", "")));
      }
      ...
      protected void RF192( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00193 */
            pr_default.execute(0, new Object[] {AV11InvitacionFecha, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A3PaisId = H00193_A3PaisId[0];
               A4LugarId = H00193_A4LugarId[0];
               A7TipoEspectaculoId = H00193_A7TipoEspectaculoId[0];
               A48EspectaculoFuncionName = H00193_A48EspectaculoFuncionName[0];
               A47EspectaculoFuncionId = H00193_A47EspectaculoFuncionId[0];
               A8TipoEspectaculoName = H00193_A8TipoEspectaculoName[0];
               A28LugarSectorName = H00193_A28LugarSectorName[0];
               A27LugarSectorId = H00193_A27LugarSectorId[0];
               n27LugarSectorId = H00193_n27LugarSectorId[0];
               A5LugarName = H00193_A5LugarName[0];
               A16EspectaculoFecha = H00193_A16EspectaculoFecha[0];
               A2EspectaculoName = H00193_A2EspectaculoName[0];
               A1EspectaculoId = H00193_A1EspectaculoId[0];
               n1EspectaculoId = H00193_n1EspectaculoId[0];
               A45InvitacionName = H00193_A45InvitacionName[0];
               n45InvitacionName = H00193_n45InvitacionName[0];
               A6PaisName = H00193_A6PaisName[0];
               A25InvitacionFecha = H00193_A25InvitacionFecha[0];
               A24InvitacionId = H00193_A24InvitacionId[0];
               A29LugarSectorCantidad = H00193_A29LugarSectorCantidad[0];
               A37LugarSectorVendidas = H00193_A37LugarSectorVendidas[0];
               n37LugarSectorVendidas = H00193_n37LugarSectorVendidas[0];
               A4LugarId = H00193_A4LugarId[0];
               A7TipoEspectaculoId = H00193_A7TipoEspectaculoId[0];
               A16EspectaculoFecha = H00193_A16EspectaculoFecha[0];
               A2EspectaculoName = H00193_A2EspectaculoName[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_INVITACIONID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A24InvitacionId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H00195 */
         pr_default.execute(1, new Object[] {AV11InvitacionFecha});
         GRID_nRecordCount = H00195_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11InvitacionFecha = context.localUtil.CToD( GridState.FilterValues("Invitacionfecha"), 2);
            AssignAttri("", false, "AV11InvitacionFecha", context.localUtil.Format(AV11InvitacionFecha, "99/99/99"));
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("InvitacionFecha", context.localUtil.Format(AV11InvitacionFecha, "99/99/99"));
      }
      ...
      protected void STRUP190( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavInvitacionfecha_Internalname), 2) == 0 )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_faildate", new   object[]  {"Invitacion Fecha"}), 1, "vINVITACIONFECHA");
               GX_FocusControl = edtavInvitacionfecha_Internalname;
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV11InvitacionFecha = DateTime.MinValue;
               AssignAttri("", false, "AV11InvitacionFecha", context.localUtil.Format(AV11InvitacionFecha, "99/99/99"));
            }
            else
            {
               AV11InvitacionFecha = context.localUtil.CToD( cgiGet( edtavInvitacionfecha_Internalname), 2);
               AssignAttri("", false, "AV11InvitacionFecha", context.localUtil.Format(AV11InvitacionFecha, "99/99/99"));
            }
            ...
            if ( DateTimeUtil.ResetTime ( context.localUtil.CToD( cgiGet( "GXH_vINVITACIONFECHA"), 2) ) != DateTimeUtil.ResetTime ( AV11InvitacionFecha ) )
            {
               GRID_nFirstRecordOnPage = 0;
            }
         }
      ...
      private void E14192( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("invitacion.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A24InvitacionId,4,0))}, new string[] {"Mode","InvitacionId"}) ;
         edtavDelete_Link = formatLink("invitacion.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A24InvitacionId,4,0))}, new string[] {"Mode","InvitacionId"}) ;
         edtInvitacionFecha_Link = formatLink("viewinvitacion.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A24InvitacionId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"InvitacionId","TabCode"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228111850463", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwinvitacion.js", "?20228111850463", false, true);
         }
      ...
      {
         edtInvitacionId_Internalname = "INVITACIONID_"+sGXsfl_25_idx;
         edtInvitacionFecha_Internalname = "INVITACIONFECHA_"+sGXsfl_25_idx;
         edtPaisName_Internalname = "PAISNAME_"+sGXsfl_25_idx;
         edtInvitacionName_Internalname = "INVITACIONNAME_"+sGXsfl_25_idx;
      ...
      {
         edtInvitacionId_Internalname = "INVITACIONID_"+sGXsfl_25_fel_idx;
         edtInvitacionFecha_Internalname = "INVITACIONFECHA_"+sGXsfl_25_fel_idx;
         edtPaisName_Internalname = "PAISNAME_"+sGXsfl_25_fel_idx;
         edtInvitacionName_Internalname = "INVITACIONNAME_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtInvitacionId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A24InvitacionId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A24InvitacionId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtInvitacionId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtInvitacionFecha_Internalname,context.localUtil.Format(A25InvitacionFecha, "99/99/99"),context.localUtil.Format( A25InvitacionFecha, "99/99/99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtInvitacionFecha_Link,(string)"",(string)"",(string)"",(string)edtInvitacionFecha_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtInvitacionName_Internalname,(string)A45InvitacionName,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtInvitacionName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl25( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A24InvitacionId), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.localUtil.Format(A25InvitacionFecha, "99/99/99"));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtInvitacionFecha_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", A45InvitacionName);
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavInvitacionfecha_Internalname = "vINVITACIONFECHA";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavInvitacionfecha_Jsonclick = "";
         edtavInvitacionfecha_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11InvitacionFecha',fld:'vINVITACIONFECHA',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14192',iparms:[{av:'A24InvitacionId',fld:'INVITACIONID',pic:'ZZZ9',hsh:true},{av:'A3PaisId',fld:'PAISID',pic:'ZZZ9'},{av:'A1EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9'},{av:'A4LugarId',fld:'LUGARID',pic:'ZZZ9'},{av:'A7TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtInvitacionFecha_Link',ctrl:'INVITACIONFECHA',prop:'Link'},{av:'edtPaisName_Link',ctrl:'PAISNAME',prop:'Link'},{av:'edtEspectaculoName_Link',ctrl:'ESPECTACULONAME',prop:'Link'},{av:'edtLugarName_Link',ctrl:'LUGARNAME',prop:'Link'},{av:'edtTipoEspectaculoName_Link',ctrl:'TIPOESPECTACULONAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11192',iparms:[{av:'A24InvitacionId',fld:'INVITACIONID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11InvitacionFecha',fld:'vINVITACIONFECHA',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11InvitacionFecha',fld:'vINVITACIONFECHA',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11InvitacionFecha',fld:'vINVITACIONFECHA',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11InvitacionFecha',fld:'vINVITACIONFECHA',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_LASTPAGE",",oparms:[]}");
         setEventMetadata("VALIDV_INVITACIONFECHA","{handler:'Validv_Invitacionfecha',iparms:[]");
         setEventMetadata("VALIDV_INVITACIONFECHA",",oparms:[]}");
      ...
      public override void initialize( )
      {
         ...
         AV17Pgmname = "";
         scmdbuf = "";
         H00193_A3PaisId = new short[1] ;
         H00193_A4LugarId = new short[1] ;
         H00193_A7TipoEspectaculoId = new short[1] ;
         H00193_A48EspectaculoFuncionName = new string[] {""} ;
         H00193_A47EspectaculoFuncionId = new short[1] ;
         H00193_A8TipoEspectaculoName = new string[] {""} ;
         H00193_A28LugarSectorName = new string[] {""} ;
         H00193_A27LugarSectorId = new short[1] ;
         H00193_n27LugarSectorId = new bool[] {false} ;
         H00193_A5LugarName = new string[] {""} ;
         H00193_A16EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H00193_A2EspectaculoName = new string[] {""} ;
         H00193_A1EspectaculoId = new short[1] ;
         H00193_n1EspectaculoId = new bool[] {false} ;
         H00193_A45InvitacionName = new string[] {""} ;
         H00193_n45InvitacionName = new bool[] {false} ;
         H00193_A6PaisName = new string[] {""} ;
         H00193_A25InvitacionFecha = new DateTime[] {DateTime.MinValue} ;
         H00193_A24InvitacionId = new short[1] ;
         H00193_A29LugarSectorCantidad = new short[1] ;
         H00193_A37LugarSectorVendidas = new short[1] ;
         H00193_n37LugarSectorVendidas = new bool[] {false} ;
         H00195_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwinvitacion__default(),
            new Object[][] {
                new Object[] {
               H00193_A3PaisId, H00193_A4LugarId, H00193_A7TipoEspectaculoId, H00193_A48EspectaculoFuncionName, H00193_A47EspectaculoFuncionId, H00193_A8TipoEspectaculoName, H00193_A28LugarSectorName, H00193_A27LugarSectorId, H00193_n27LugarSectorId, H00193_A5LugarName,
               H00193_A16EspectaculoFecha, H00193_A2EspectaculoName, H00193_A1EspectaculoId, H00193_n1EspectaculoId, H00193_A45InvitacionName, H00193_n45InvitacionName, H00193_A6PaisName, H00193_A25InvitacionFecha, H00193_A24InvitacionId, H00193_A29LugarSectorCantidad,
               H00193_A37LugarSectorVendidas, H00193_n37LugarSectorVendidas
               }
               , new Object[] {
               H00195_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "WWInvitacion";
      ...
      private int edtavInvitacionfecha_Enabled ;
      ...
      private string edtavInvitacionfecha_Internalname ;
      private string edtavInvitacionfecha_Jsonclick ;
      ...
      private string edtInvitacionFecha_Link ;
      ...
      private DateTime AV11InvitacionFecha ;
      ...
      private short[] H00193_A3PaisId ;
      private short[] H00193_A4LugarId ;
      private short[] H00193_A7TipoEspectaculoId ;
      private string[] H00193_A48EspectaculoFuncionName ;
      private short[] H00193_A47EspectaculoFuncionId ;
      private string[] H00193_A8TipoEspectaculoName ;
      private string[] H00193_A28LugarSectorName ;
      private short[] H00193_A27LugarSectorId ;
      private bool[] H00193_n27LugarSectorId ;
      private string[] H00193_A5LugarName ;
      private DateTime[] H00193_A16EspectaculoFecha ;
      private string[] H00193_A2EspectaculoName ;
      private short[] H00193_A1EspectaculoId ;
      private bool[] H00193_n1EspectaculoId ;
      private string[] H00193_A45InvitacionName ;
      private bool[] H00193_n45InvitacionName ;
      private string[] H00193_A6PaisName ;
      private DateTime[] H00193_A25InvitacionFecha ;
      private short[] H00193_A24InvitacionId ;
      private short[] H00193_A29LugarSectorCantidad ;
      private short[] H00193_A37LugarSectorVendidas ;
      private bool[] H00193_n37LugarSectorVendidas ;
      private long[] H00195_AGRID_nRecordCount ;
   ...
   public class wwinvitacion__default : DataStoreHelperBase, IDataStoreHelper
   {
      ...
      protected Object[] conditional_H00195( IGxContext context ,
                                             DateTime AV11InvitacionFecha ,
                                             DateTime A25InvitacionFecha )
      {
         System.Text.StringBuilder sWhereString = new System.Text.StringBuilder();
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((((((([Invitacion] T1 INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) INNER JOIN [Lugar] T3 ON T3.[LugarId] = T2.[LugarId]) INNER JOIN [Pais] T4 ON T4.[PaisId] = T3.[PaisId]) LEFT JOIN [LugarSector] T6 ON T6.[LugarId] = T2.[LugarId] AND T6.[LugarSectorId] = T1.[LugarSectorId]) INNER JOIN [TipoEspectaculo] T5 ON T5.[TipoEspectaculoId] = T2.[TipoEspectaculoId]) INNER JOIN [EspectaculoFuncion] T7 ON T7.[EspectaculoId] = T1.[EspectaculoId] AND T7.[EspectaculoFuncionId] = T1.[EspectaculoFuncionId]) LEFT JOIN (SELECT COUNT(*) AS LugarSectorVendidas, [EspectaculoId], [LugarSectorId] FROM [Entrada] GROUP BY [EspectaculoId], [LugarSectorId] ) T8 ON T8.[EspectaculoId] = T1.[EspectaculoId] AND T8.[LugarSectorId] = T1.[LugarSectorId])";
         if ( ! (DateTime.MinValue==AV11InvitacionFecha) )
         {
            AddWhere(sWhereString, "(T1.[InvitacionFecha] >= @AV11InvitacionFecha)");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00193(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] );
               case 1 :
                     return conditional_H00195(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV11InvitacionFecha",GXType.Date,8,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00193", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00193,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00195", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00195,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
