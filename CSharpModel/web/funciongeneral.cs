...
namespace GeneXus.Programs {
   public class funciongeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public funciongeneral( IGxContext context )
      {
      ...
      {
         this.A15FuncionId = aP0_FuncionId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A15FuncionId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Funcion General") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("funciongeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A15FuncionId,4,0))}, new string[] {"FuncionId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA15FuncionId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA15FuncionId), 4, 0, ",", "")));
      }
      ...
      protected void WB160( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "funciongeneral.aspx");
            }
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modificar", bttBtnupdate_Jsonclick, 7, "Modificar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11161_client"+"'", TempTags, "", 2, "HLP_FuncionGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12161_client"+"'", TempTags, "", 2, "HLP_FuncionGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPrecioFuncion_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A21PrecioFuncion), 4, 0, ",", "")), StringUtil.LTrim( ((edtPrecioFuncion_Enabled!=0) ? context.localUtil.Format( (decimal)(A21PrecioFuncion), "ZZZ9") : context.localUtil.Format( (decimal)(A21PrecioFuncion), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPrecioFuncion_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPrecioFuncion_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_FuncionGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START162( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Funcion General", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void STRUP160( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA15FuncionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA15FuncionId"), ",", "."));
      ...
      protected void S112( )
      {
         ...
         AV7TrnContext.gxTpr_Transactionname = "Funcion";
         AV8TrnContextAtt = new SdtTransactionContext_Attribute(context);
         AV8TrnContextAtt.gxTpr_Attributename = "FuncionId";
         AV8TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6FuncionId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A15FuncionId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A15FuncionId", StringUtil.LTrimStr( (decimal)(A15FuncionId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA15FuncionId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "funciongeneral", GetJustCreated( ));
         ...
         {
            A15FuncionId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A15FuncionId", StringUtil.LTrimStr( (decimal)(A15FuncionId), 4, 0));
         }
         wcpOA15FuncionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA15FuncionId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( A15FuncionId != wcpOA15FuncionId ) ) )
         {
            setjustcreated();
         }
         wcpOA15FuncionId = A15FuncionId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA15FuncionId = cgiGet( sPrefix+"A15FuncionId_CTRL");
         if ( StringUtil.Len( sCtrlA15FuncionId) > 0 )
         {
            A15FuncionId = (short)(context.localUtil.CToN( cgiGet( sCtrlA15FuncionId), ",", "."));
            AssignAttri(sPrefix, false, "A15FuncionId", StringUtil.LTrimStr( (decimal)(A15FuncionId), 4, 0));
         }
         else
         {
            A15FuncionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"A15FuncionId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A15FuncionId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A15FuncionId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA15FuncionId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A15FuncionId_CTRL", StringUtil.RTrim( sCtrlA15FuncionId));
         }
      }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DODELETE'","{handler:'E12161',iparms:[{av:'A15FuncionId',fld:'FUNCIONID',pic:'ZZZ9'}]");
      ...
      private short wcpOA15FuncionId ;
   ...
   public class funciongeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
