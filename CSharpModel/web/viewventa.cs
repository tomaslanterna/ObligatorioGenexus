...
namespace GeneXus.Programs {
   public class viewventa : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewventa( )
      {
      ...
      public viewventa( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12VentaId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12VentaId", StringUtil.LTrimStr( (decimal)(AV12VentaId), 4, 0));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228822351975", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewventa.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12VentaId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"VentaId","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("ValorPorAsiento", context.localUtil.Format( (decimal)(A12ValorPorAsiento), "ZZZ9"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewventa:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vVENTAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12VentaId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vVENTAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12VentaId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewventa.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12VentaId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"VentaId","TabCode"})  ;
      }
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Venta Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewVenta.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Ventas", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewVenta.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtValorPorAsiento_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A12ValorPorAsiento), 4, 0, ",", "")), StringUtil.LTrim( ((edtValorPorAsiento_Enabled!=0) ? context.localUtil.Format( (decimal)(A12ValorPorAsiento), "ZZZ9") : context.localUtil.Format( (decimal)(A12ValorPorAsiento), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtValorPorAsiento_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtValorPorAsiento_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ViewVenta.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewVenta.htm");
            /* Div Control */
      ...
      protected void START0I2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Venta", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A11VentaId = H000I2_A11VentaId[0];
               A12ValorPorAsiento = H000I2_A12ValorPorAsiento[0];
      ...
      protected void STRUP0I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12VentaId = (short)(context.localUtil.CToN( cgiGet( "vVENTAID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewventa:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110I2( )
      {
         ...
         {
            A11VentaId = H000I3_A11VentaId[0];
            A12ValorPorAsiento = H000I3_A12ValorPorAsiento[0];
            AssignAttri("", false, "A12ValorPorAsiento", StringUtil.LTrimStr( (decimal)(A12ValorPorAsiento), 4, 0));
            AV16GXLvl6 = 1;
            Form.Caption = StringUtil.Str( (decimal)(A12ValorPorAsiento), 4, 0);
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "VentaGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "ventageneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "VentaGeneral";
               WebComp_Generalwc_Component = "VentaGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12VentaId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12VentaId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12VentaId", StringUtil.LTrimStr( (decimal)(AV12VentaId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vVENTAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12VentaId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228822351991", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewventa.js", "?20228822351991", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12VentaId',fld:'vVENTAID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A12ValorPorAsiento',fld:'VALORPORASIENTO',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000I2_A11VentaId = new short[1] ;
         H000I2_A12ValorPorAsiento = new short[1] ;
         hsh = "";
         H000I3_A11VentaId = new short[1] ;
         H000I3_A12ValorPorAsiento = new short[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewventa__default(),
            new Object[][] {
                new Object[] {
               H000I2_A11VentaId, H000I2_A12ValorPorAsiento
               }
               , new Object[] {
               H000I3_A11VentaId, H000I3_A12ValorPorAsiento
               }
            }
         );
      ...
      private short AV12VentaId ;
      private short wcpOAV12VentaId ;
      ...
      private short[] H000I2_A11VentaId ;
      private short[] H000I2_A12ValorPorAsiento ;
      private short[] H000I3_A11VentaId ;
      private short[] H000I3_A12ValorPorAsiento ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewventa__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12VentaId",GXType.Int16,4,0)
          };
          Object[] prmH000I3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000I2", "SELECT [VentaId], [ValorPorAsiento] FROM [Venta] WHERE [VentaId] = @AV12VentaId ORDER BY [VentaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000I3", "SELECT [VentaId], [ValorPorAsiento] FROM [Venta] WHERE [VentaId] = @AV12VentaId ORDER BY [VentaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
