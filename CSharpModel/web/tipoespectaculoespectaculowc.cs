...
namespace GeneXus.Programs {
   public class tipoespectaculoespectaculowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public tipoespectaculoespectaculowc( )
      {
      ...
      public tipoespectaculoespectaculowc( IGxContext context )
      {
      ...
      public void execute( short aP0_TipoEspectaculoId )
      {
         this.AV6TipoEspectaculoId = aP0_TipoEspectaculoId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "TipoEspectaculoId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6TipoEspectaculoId = (short)(NumberUtil.Val( GetPar( "TipoEspectaculoId"), "."));
                  AssignAttri(sPrefix, false, "AV6TipoEspectaculoId", StringUtil.LTrimStr( (decimal)(AV6TipoEspectaculoId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6TipoEspectaculoId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6TipoEspectaculoId, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "TipoEspectaculoEspectaculoWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Tipo Espectaculo Espectaculo WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281012272792", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("tipoespectaculoespectaculowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6TipoEspectaculoId,4,0))}, new string[] {"TipoEspectaculoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6TipoEspectaculoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6TipoEspectaculoId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTIPOESPECTACULOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6TipoEspectaculoId), 4, 0, ",", "")));
      ...
      {
         return "TipoEspectaculoEspectaculoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Tipo Espectaculo Espectaculo WC" ;
      }
      ...
      protected void WB130( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tipoespectaculoespectaculowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TipoEspectaculoEspectaculoWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            GxWebStd.gx_label_element( context, edtTipoEspectaculoId_Internalname, "Tipo Espectaculo Id", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTipoEspectaculoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A7TipoEspectaculoId), 4, 0, ",", "")), StringUtil.LTrim( ((edtTipoEspectaculoId_Enabled!=0) ? context.localUtil.Format( (decimal)(A7TipoEspectaculoId), "ZZZ9") : context.localUtil.Format( (decimal)(A7TipoEspectaculoId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTipoEspectaculoId_Jsonclick, 0, "Attribute", "", "", "", "", edtTipoEspectaculoId_Visible, edtTipoEspectaculoId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_TipoEspectaculoEspectaculoWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START132( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Tipo Espectaculo Espectaculo WC", 0) ;
            }
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtEspectaculoImagen_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A26EspectaculoImagen)) ? A40000EspectaculoImagen_GXI : context.convertURL( context.PathToRelativeUrl( A26EspectaculoImagen))), !bGXsfl_20_Refreshing);
                              AssignProp(sPrefix, false, edtEspectaculoImagen_Internalname, "SrcSet", context.GetImageSrcSet( A26EspectaculoImagen), true);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ESPECTACULOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A1EspectaculoId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"ESPECTACULOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EspectaculoId), 4, 0, ".", "")));
      }
      ...
      protected void RF132( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00132 */
            pr_default.execute(0, new Object[] {AV6TipoEspectaculoId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_20_idx = 1;
            sGXsfl_20_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_20_idx), 4, 0), 4, "0");
            SubsflControlProps_202( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A7TipoEspectaculoId = H00132_A7TipoEspectaculoId[0];
               AssignAttri(sPrefix, false, "A7TipoEspectaculoId", StringUtil.LTrimStr( (decimal)(A7TipoEspectaculoId), 4, 0));
               A16EspectaculoFecha = H00132_A16EspectaculoFecha[0];
               A40000EspectaculoImagen_GXI = H00132_A40000EspectaculoImagen_GXI[0];
               AssignProp(sPrefix, false, edtEspectaculoImagen_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A26EspectaculoImagen)) ? A40000EspectaculoImagen_GXI : context.convertURL( context.PathToRelativeUrl( A26EspectaculoImagen))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoImagen_Internalname, "SrcSet", context.GetImageSrcSet( A26EspectaculoImagen), true);
               A5LugarName = H00132_A5LugarName[0];
               A4LugarId = H00132_A4LugarId[0];
               A6PaisName = H00132_A6PaisName[0];
               A3PaisId = H00132_A3PaisId[0];
               A2EspectaculoName = H00132_A2EspectaculoName[0];
               A1EspectaculoId = H00132_A1EspectaculoId[0];
               A26EspectaculoImagen = H00132_A26EspectaculoImagen[0];
               AssignProp(sPrefix, false, edtEspectaculoImagen_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A26EspectaculoImagen)) ? A40000EspectaculoImagen_GXI : context.convertURL( context.PathToRelativeUrl( A26EspectaculoImagen))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoImagen_Internalname, "SrcSet", context.GetImageSrcSet( A26EspectaculoImagen), true);
               A5LugarName = H00132_A5LugarName[0];
               A3PaisId = H00132_A3PaisId[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ESPECTACULOID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A1EspectaculoId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H00133 */
         pr_default.execute(1, new Object[] {AV6TipoEspectaculoId});
      ...
      protected void STRUP130( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6TipoEspectaculoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6TipoEspectaculoId"), ",", "."));
      ...
      protected void E12132( )
      {
         ...
         AV13Delete = "Eliminar";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtTipoEspectaculoId_Visible = 0;
         AssignProp(sPrefix, false, edtTipoEspectaculoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtTipoEspectaculoId_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "TipoEspectaculoId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6TipoEspectaculoId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6TipoEspectaculoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6TipoEspectaculoId", StringUtil.LTrimStr( (decimal)(AV6TipoEspectaculoId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6TipoEspectaculoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tipoespectaculoespectaculowc", GetJustCreated( ));
         ...
         {
            AV6TipoEspectaculoId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6TipoEspectaculoId", StringUtil.LTrimStr( (decimal)(AV6TipoEspectaculoId), 4, 0));
         }
         wcpOAV6TipoEspectaculoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6TipoEspectaculoId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV6TipoEspectaculoId != wcpOAV6TipoEspectaculoId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6TipoEspectaculoId = AV6TipoEspectaculoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6TipoEspectaculoId = cgiGet( sPrefix+"AV6TipoEspectaculoId_CTRL");
         if ( StringUtil.Len( sCtrlAV6TipoEspectaculoId) > 0 )
         {
            AV6TipoEspectaculoId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6TipoEspectaculoId), ",", "."));
            AssignAttri(sPrefix, false, "AV6TipoEspectaculoId", StringUtil.LTrimStr( (decimal)(AV6TipoEspectaculoId), 4, 0));
         }
         else
         {
            AV6TipoEspectaculoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6TipoEspectaculoId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6TipoEspectaculoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6TipoEspectaculoId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6TipoEspectaculoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6TipoEspectaculoId_CTRL", StringUtil.RTrim( sCtrlAV6TipoEspectaculoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281012272813", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tipoespectaculoespectaculowc.js", "?202281012272813", false, true);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtPaisId_Internalname = sPrefix+"PAISID_"+sGXsfl_20_idx;
         ...
         edtEspectaculoImagen_Internalname = sPrefix+"ESPECTACULOIMAGEN_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtPaisId_Internalname = sPrefix+"PAISID_"+sGXsfl_20_fel_idx;
         ...
         edtEspectaculoImagen_Internalname = sPrefix+"ESPECTACULOIMAGEN_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A3PaisId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A3PaisId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPaisId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtLugarId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A4LugarId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A4LugarId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtLugarId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtEspectaculoImagen_Internalname = sPrefix+"ESPECTACULOIMAGEN";
      ...
      public override void initialize_properties( )
      {
         ...
         edtTipoEspectaculoId_Visible = 1;
         subGrid_Rows = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6TipoEspectaculoId',fld:'vTIPOESPECTACULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E13132',iparms:[{av:'A1EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true},{av:'A3PaisId',fld:'PAISID',pic:'ZZZ9'},{av:'A4LugarId',fld:'LUGARID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtEspectaculoName_Link',ctrl:'ESPECTACULONAME',prop:'Link'},{av:'edtPaisName_Link',ctrl:'PAISNAME',prop:'Link'},{av:'edtLugarName_Link',ctrl:'LUGARNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11132',iparms:[{av:'A1EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6TipoEspectaculoId',fld:'vTIPOESPECTACULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6TipoEspectaculoId',fld:'vTIPOESPECTACULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6TipoEspectaculoId',fld:'vTIPOESPECTACULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6TipoEspectaculoId',fld:'vTIPOESPECTACULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00132_A7TipoEspectaculoId = new short[1] ;
         H00132_A16EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H00132_A40000EspectaculoImagen_GXI = new string[] {""} ;
         H00132_A5LugarName = new string[] {""} ;
         H00132_A4LugarId = new short[1] ;
         H00132_A6PaisName = new string[] {""} ;
         H00132_A3PaisId = new short[1] ;
         H00132_A2EspectaculoName = new string[] {""} ;
         H00132_A1EspectaculoId = new short[1] ;
         H00132_A26EspectaculoImagen = new string[] {""} ;
         ...
         sCtrlAV6TipoEspectaculoId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         sImgUrl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tipoespectaculoespectaculowc__default(),
            new Object[][] {
                new Object[] {
               H00132_A7TipoEspectaculoId, H00132_A16EspectaculoFecha, H00132_A40000EspectaculoImagen_GXI, H00132_A5LugarName, H00132_A4LugarId, H00132_A6PaisName, H00132_A3PaisId, H00132_A2EspectaculoName, H00132_A1EspectaculoId, H00132_A26EspectaculoImagen
               }
               , new Object[] {
      ...
      private short AV6TipoEspectaculoId ;
      private short wcpOAV6TipoEspectaculoId ;
      ...
      private int edtTipoEspectaculoId_Visible ;
      ...
      private string sCtrlAV6TipoEspectaculoId ;
      ...
      private short[] H00132_A7TipoEspectaculoId ;
      private DateTime[] H00132_A16EspectaculoFecha ;
      private string[] H00132_A40000EspectaculoImagen_GXI ;
      private string[] H00132_A5LugarName ;
      private short[] H00132_A4LugarId ;
      private string[] H00132_A6PaisName ;
      private short[] H00132_A3PaisId ;
      private string[] H00132_A2EspectaculoName ;
      private short[] H00132_A1EspectaculoId ;
      private string[] H00132_A26EspectaculoImagen ;
   ...
   public class tipoespectaculoespectaculowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6TipoEspectaculoId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00132", "SELECT T1.[TipoEspectaculoId], T1.[EspectaculoFecha], T1.[EspectaculoImagen_GXI], T2.[LugarName], T1.[LugarId], T3.[PaisName], T2.[PaisId], T1.[EspectaculoName], T1.[EspectaculoId], T1.[EspectaculoImagen] FROM (([Espectaculo] T1 INNER JOIN [Lugar] T2 ON T2.[LugarId] = T1.[LugarId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T2.[PaisId]) WHERE T1.[TipoEspectaculoId] = @AV6TipoEspectaculoId ORDER BY T1.[TipoEspectaculoId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00132,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00133", "SELECT COUNT(*) FROM (([Espectaculo] T1 INNER JOIN [Lugar] T2 ON T2.[LugarId] = T1.[LugarId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T2.[PaisId]) WHERE T1.[TipoEspectaculoId] = @AV6TipoEspectaculoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00133,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
