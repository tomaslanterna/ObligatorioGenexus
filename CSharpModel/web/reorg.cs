...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeEntrada( )
      {
         string cmdBuffer = "";
         /* Indices for table Entrada */
         cmdBuffer=" ALTER TABLE [Entrada] ADD [EspectaculoPaisName] nvarchar(40) NOT NULL CONSTRAINT EspectaculoPaisNameEntrada_DEFAULT DEFAULT '' "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE [Entrada] DROP CONSTRAINT EspectaculoPaisNameEntrada_DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE [Entrada] DROP COLUMN [EntradaPaisOrigenId], [EntradaPaisOrigenName] "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            EntradaCount = P00012_AEntradaCount[0];
            pr_default.close(0);
            PrintRecordCount ( "Entrada" ,  EntradaCount );
         }
      }
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("Entrada",sSchemaVar,"EspectaculoPaisName") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"EspectaculoPaisName", "Entrada"}) ) ;
            return false ;
         }
         if ( ! ColumnExist("Entrada",sSchemaVar,"EntradaPaisOrigenId") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_not_exist", new   object[]  {"EntradaPaisOrigenId", "Entrada"}) ) ;
            return false ;
         }
         if ( ! ColumnExist("Entrada",sSchemaVar,"EntradaPaisOrigenName") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_not_exist", new   object[]  {"EntradaPaisOrigenName", "Entrada"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "ReorganizeEntrada" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"Entrada", ""}) );
      }
      ...
      {
         scmdbuf = "";
         P00012_AEntradaCount = new int[1] ;
         sSchemaVar = "";
         nsSchemaVar = false;
      ...
      protected int[] P00012_AEntradaCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM [Entrada] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100, GxCacheFrequency.OFF ,true,false )
