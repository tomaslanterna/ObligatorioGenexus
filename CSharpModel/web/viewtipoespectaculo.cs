...
namespace GeneXus.Programs {
   public class viewtipoespectaculo : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewtipoespectaculo( )
      {
      ...
      public viewtipoespectaculo( IGxContext context )
      {
      ...
      public void execute( short aP0_TipoEspectaculoId ,
                           string aP1_TabCode )
      {
         this.AV12TipoEspectaculoId = aP0_TipoEspectaculoId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12TipoEspectaculoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12TipoEspectaculoId", StringUtil.LTrimStr( (decimal)(AV12TipoEspectaculoId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vTIPOESPECTACULOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12TipoEspectaculoId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281012272895", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewtipoespectaculo.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12TipoEspectaculoId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"TipoEspectaculoId","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewTipoEspectaculo");
         forbiddenHiddens.Add("TipoEspectaculoName", StringUtil.RTrim( context.localUtil.Format( A8TipoEspectaculoName, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewtipoespectaculo:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTIPOESPECTACULOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12TipoEspectaculoId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPOESPECTACULOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12TipoEspectaculoId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewtipoespectaculo.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12TipoEspectaculoId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"TipoEspectaculoId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "ViewTipoEspectaculo" ;
      }

      public override string GetPgmdesc( )
      {
         return "View Tipo Espectaculo" ;
      }
      ...
      protected void WB100( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Tipo Espectaculo Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewTipoEspectaculo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Tipo Espectaculoes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewTipoEspectaculo.htm");
            ...
            GxWebStd.gx_label_element( context, edtTipoEspectaculoName_Internalname, "Espectaculo Name", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTipoEspectaculoName_Internalname, A8TipoEspectaculoName, StringUtil.RTrim( context.localUtil.Format( A8TipoEspectaculoName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTipoEspectaculoName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtTipoEspectaculoName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_ViewTipoEspectaculo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewTipoEspectaculo.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblEspectaculo_title_Internalname, "Espectaculo", "", "", lblEspectaculo_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewTipoEspectaculo.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTableespectaculo_Internalname, 1, 0, "px", 0, "px", "TabsFormContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0038"+"", StringUtil.RTrim( WebComp_Espectaculowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void START102( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Tipo Espectaculo", 0) ;
         }
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 38 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Espectaculowc_Component) != 0 )
                           {
                              WebComp_Espectaculowc.componentprocess("W0038", "", sEvt);
                           }
                           WebComp_Espectaculowc_Component = OldEspectaculowc;
                        }
                     }
      ...
      {
         /* GeneXus formulas. */
         AV15Pgmname = "ViewTipoEspectaculo";
         context.Gx_err = 0;
      }
      ...
      protected void RF102( )
      {
         ...
         {
            /* Using cursor H00102 */
            pr_default.execute(0, new Object[] {AV12TipoEspectaculoId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A7TipoEspectaculoId = H00102_A7TipoEspectaculoId[0];
               A8TipoEspectaculoName = H00102_A8TipoEspectaculoName[0];
      ...
      protected void STRUP100( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12TipoEspectaculoId = (short)(context.localUtil.CToN( cgiGet( "vTIPOESPECTACULOID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewtipoespectaculo:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E11102( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H00103 */
         pr_default.execute(1, new Object[] {AV12TipoEspectaculoId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A7TipoEspectaculoId = H00103_A7TipoEspectaculoId[0];
            A8TipoEspectaculoName = H00103_A8TipoEspectaculoName[0];
            AssignAttri("", false, "A8TipoEspectaculoName", A8TipoEspectaculoName);
            AV16GXLvl6 = 1;
            Form.Caption = A8TipoEspectaculoName;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwtipoespectaculo.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "TipoEspectaculoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "tipoespectaculogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "TipoEspectaculoGeneral";
               WebComp_Generalwc_Component = "TipoEspectaculoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12TipoEspectaculoId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Espectaculo") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Espectaculowc_Component), StringUtil.Lower( "TipoEspectaculoEspectaculoWC")) != 0 )
            {
               WebComp_Espectaculowc = getWebComponent(GetType(), "GeneXus.Programs", "tipoespectaculoespectaculowc", new Object[] {context} );
               WebComp_Espectaculowc.ComponentInit();
               WebComp_Espectaculowc.Name = "TipoEspectaculoEspectaculoWC";
               WebComp_Espectaculowc_Component = "TipoEspectaculoEspectaculoWC";
            }
            if ( StringUtil.Len( WebComp_Espectaculowc_Component) != 0 )
            {
               WebComp_Espectaculowc.setjustcreated();
               WebComp_Espectaculowc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12TipoEspectaculoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12TipoEspectaculoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12TipoEspectaculoId", StringUtil.LTrimStr( (decimal)(AV12TipoEspectaculoId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vTIPOESPECTACULOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12TipoEspectaculoId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228101227297", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewtipoespectaculo.js", "?20228101227297", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Tipo Espectaculo";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12TipoEspectaculoId',fld:'vTIPOESPECTACULOID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A8TipoEspectaculoName',fld:'TIPOESPECTACULONAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00102_A7TipoEspectaculoId = new short[1] ;
         H00102_A8TipoEspectaculoName = new string[] {""} ;
         hsh = "";
         H00103_A7TipoEspectaculoId = new short[1] ;
         H00103_A8TipoEspectaculoName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewtipoespectaculo__default(),
            new Object[][] {
                new Object[] {
               H00102_A7TipoEspectaculoId, H00102_A8TipoEspectaculoName
               }
               , new Object[] {
               H00103_A7TipoEspectaculoId, H00103_A8TipoEspectaculoName
               }
            }
         );
      ...
      private short AV12TipoEspectaculoId ;
      private short wcpOAV12TipoEspectaculoId ;
      ...
      private short[] H00102_A7TipoEspectaculoId ;
      private string[] H00102_A8TipoEspectaculoName ;
      private short[] H00103_A7TipoEspectaculoId ;
      private string[] H00103_A8TipoEspectaculoName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewtipoespectaculo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12TipoEspectaculoId",GXType.Int16,4,0)
          };
          Object[] prmH00103;
          ...
          def= new CursorDef[] {
              new CursorDef("H00102", "SELECT [TipoEspectaculoId], [TipoEspectaculoName] FROM [TipoEspectaculo] WHERE [TipoEspectaculoId] = @AV12TipoEspectaculoId ORDER BY [TipoEspectaculoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00102,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00103", "SELECT [TipoEspectaculoId], [TipoEspectaculoName] FROM [TipoEspectaculo] WHERE [TipoEspectaculoId] = @AV12TipoEspectaculoId ORDER BY [TipoEspectaculoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00103,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
