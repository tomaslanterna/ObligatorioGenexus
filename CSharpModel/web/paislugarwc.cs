...
namespace GeneXus.Programs {
   public class paislugarwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public paislugarwc( )
      {
      ...
      public paislugarwc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6PaisId = (short)(NumberUtil.Val( GetPar( "PaisId"), "."));
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Pais Lugar WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281118495457", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("paislugarwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6PaisId,4,0))}, new string[] {"PaisId"}) +"\">") ;
      ...
      protected void WB0Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "paislugarwc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_PaisLugarWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A3PaisId), 4, 0, ",", "")), StringUtil.LTrim( ((edtPaisId_Enabled!=0) ? context.localUtil.Format( (decimal)(A3PaisId), "ZZZ9") : context.localUtil.Format( (decimal)(A3PaisId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisId_Jsonclick, 0, "Attribute", "", "", "", "", edtPaisId_Visible, edtPaisId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_PaisLugarWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0Y2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Pais Lugar WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_LUGARID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A4LugarId), "ZZZ9"), context));
      ...
      protected void RF0Y2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A3PaisId = H000Y2_A3PaisId[0];
               AssignAttri(sPrefix, false, "A3PaisId", StringUtil.LTrimStr( (decimal)(A3PaisId), 4, 0));
               A5LugarName = H000Y2_A5LugarName[0];
               A4LugarId = H000Y2_A4LugarId[0];
               E130Y2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_LUGARID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A4LugarId), "ZZZ9"), context));
      }
      ...
      protected void STRUP0Y0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6PaisId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6PaisId"), ",", "."));
      ...
      private void E130Y2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("lugar.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A4LugarId,4,0))}, new string[] {"Mode","LugarId"}) ;
         edtavDelete_Link = formatLink("lugar.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A4LugarId,4,0))}, new string[] {"Mode","LugarId"}) ;
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Lugar";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "paislugarwc", GetJustCreated( ));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6PaisId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6PaisId), ",", "."));
            AssignAttri(sPrefix, false, "AV6PaisId", StringUtil.LTrimStr( (decimal)(AV6PaisId), 4, 0));
         }
         else
         {
            AV6PaisId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6PaisId_PARM"), ",", "."));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281118495477", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("paislugarwc.js", "?202281118495477", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisId',fld:'vPAISID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E130Y2',iparms:[{av:'A4LugarId',fld:'LUGARID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtLugarName_Link',ctrl:'LUGARNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110Y2',iparms:[{av:'A4LugarId',fld:'LUGARID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisId',fld:'vPAISID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisId',fld:'vPAISID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisId',fld:'vPAISID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisId',fld:'vPAISID',pic:'ZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         A5LugarName = "";
         scmdbuf = "";
         H000Y2_A3PaisId = new short[1] ;
         H000Y2_A5LugarName = new string[] {""} ;
         H000Y2_A4LugarId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paislugarwc__default(),
            new Object[][] {
                new Object[] {
               H000Y2_A3PaisId, H000Y2_A5LugarName, H000Y2_A4LugarId
               }
               , new Object[] {
      ...
      private short[] H000Y2_A3PaisId ;
      private string[] H000Y2_A5LugarName ;
      private short[] H000Y2_A4LugarId ;
   ...
   public class paislugarwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000Y2", "SELECT [PaisId], [LugarName], [LugarId] FROM [Lugar] WHERE [PaisId] = @AV6PaisId ORDER BY [PaisId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Y2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000Y3", "SELECT COUNT(*) FROM [Lugar] WHERE [PaisId] = @AV6PaisId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Y3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
