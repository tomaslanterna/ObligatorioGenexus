...
namespace GeneXus.Programs {
   public class gx00d1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV8cLugarSectorEstadoSector = StringUtil.StrToBool( GetPar( "cLugarSectorEstadoSector"));
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cLugarSectorId, AV8cLugarSectorEstadoSector, AV9pEspectaculoId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022892272038", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCLUGARSECTORESTADOSECTOR", StringUtil.BoolToStr( AV8cLugarSectorEstadoSector));
         /* Send saved values. */
      ...
      protected void WB1R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbllugarsectorestadosectorfilter_Internalname, "Lugar Sector Estado Sector", "", "", lblLbllugarsectorestadosectorfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e121r1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00D1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavClugarsectorestadosector_Internalname, StringUtil.BoolToStr( AV8cLugarSectorEstadoSector), "", "Lugar Sector Estado Sector", chkavClugarsectorestadosector.Visible, chkavClugarsectorestadosector.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(26, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,26);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e131r1_client"+"'", TempTags, "", 2, "HLP_Gx00D1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 34 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00D1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavLinkselection_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5LinkSelection)) ? AV14Linkselection_GXI : context.convertURL( context.PathToRelativeUrl( AV5LinkSelection))), !bGXsfl_34_Refreshing);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrToBool( cgiGet( "GXH_vCLUGARSECTORESTADOSECTOR")) != AV8cLugarSectorEstadoSector )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        ...
                                        bool AV8cLugarSectorEstadoSector ,
      ...
      {
         AV8cLugarSectorEstadoSector = StringUtil.StrToBool( StringUtil.BoolToStr( AV8cLugarSectorEstadoSector));
         AssignAttri("", false, "AV8cLugarSectorEstadoSector", AV8cLugarSectorEstadoSector);
      }
      ...
      protected void RF1R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H001R2 */
            pr_default.execute(0, new Object[] {AV9pEspectaculoId, AV6cLugarSectorId, AV8cLugarSectorEstadoSector, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_34_idx = 1;
            sGXsfl_34_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_34_idx), 4, 0), 4, "0");
            SubsflControlProps_342( ) ;
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         /* Using cursor H001R3 */
         pr_default.execute(1, new Object[] {AV9pEspectaculoId, AV6cLugarSectorId, AV8cLugarSectorEstadoSector});
      ...
      protected void STRUP1R0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV8cLugarSectorEstadoSector = StringUtil.StrToBool( cgiGet( chkavClugarsectorestadosector_Internalname));
            AssignAttri("", false, "AV8cLugarSectorEstadoSector", AV8cLugarSectorEstadoSector);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2022892272053", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00d1.js", "?2022892272053", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLugarSectorId',fld:'vCLUGARSECTORID',pic:'ZZZ9'},{av:'AV9pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'},{av:'AV8cLugarSectorEstadoSector',fld:'vCLUGARSECTORESTADOSECTOR',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E131R1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         ...
         setEventMetadata("LBLLUGARSECTORESTADOSECTORFILTER.CLICK","{handler:'E121R1',iparms:[{av:'divLugarsectorestadosectorfiltercontainer_Class',ctrl:'LUGARSECTORESTADOSECTORFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E161R2',iparms:[{av:'A27LugarSectorId',fld:'LUGARSECTORID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV10pLugarSectorId',fld:'vPLUGARSECTORID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLugarSectorId',fld:'vCLUGARSECTORID',pic:'ZZZ9'},{av:'AV9pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'},{av:'AV8cLugarSectorEstadoSector',fld:'vCLUGARSECTORESTADOSECTOR',pic:''}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLugarSectorId',fld:'vCLUGARSECTORID',pic:'ZZZ9'},{av:'AV9pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'},{av:'AV8cLugarSectorEstadoSector',fld:'vCLUGARSECTORESTADOSECTOR',pic:''}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLugarSectorId',fld:'vCLUGARSECTORID',pic:'ZZZ9'},{av:'AV9pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'},{av:'AV8cLugarSectorEstadoSector',fld:'vCLUGARSECTORESTADOSECTOR',pic:''}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLugarSectorId',fld:'vCLUGARSECTORID',pic:'ZZZ9'},{av:'AV9pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'},{av:'AV8cLugarSectorEstadoSector',fld:'vCLUGARSECTORESTADOSECTOR',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H001R2_A41LugarSectorEstadoSector = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00d1__default(),
            new Object[][] {
                new Object[] {
               H001R2_A1EspectaculoId, H001R2_A41LugarSectorEstadoSector, H001R2_A27LugarSectorId
               }
               , new Object[] {
      ...
      private bool AV8cLugarSectorEstadoSector ;
      private bool wbLoad ;
      private bool Rfr0gs ;
      private bool wbErr ;
      ...
      private bool[] H001R2_A41LugarSectorEstadoSector ;
   ...
   public class gx00d1__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A1EspectaculoId )
      {
         ...
         if ( ! (false==AV8cLugarSectorEstadoSector) )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001R2(context, (bool)dynConstraints[0] , (bool)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H001R3(context, (bool)dynConstraints[0] , (bool)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8cLugarSectorEstadoSector",GXType.Boolean,4,0) ,
