...
namespace GeneXus.Programs {
   public class espectaculoventawc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public espectaculoventawc( )
      {
      ...
      public espectaculoventawc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6EspectaculoId, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "EspectaculoVentaWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Espectaculo Venta WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022882192079", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("espectaculoventawc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6EspectaculoId,4,0))}, new string[] {"EspectaculoId"}) +"\">") ;
      ...
      {
         return "EspectaculoVentaWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Espectaculo Venta WC" ;
      }
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "espectaculoventawc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EspectaculoVentaWC.htm");
      ...
      protected void START0S2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Espectaculo Venta WC", 0) ;
            }
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A10ClienteName = (short)(context.localUtil.CToN( cgiGet( edtClienteName_Internalname), ",", "."));
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_VENTAID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A11VentaId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"VENTAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A11VentaId), 4, 0, ".", "")));
      }
      ...
      protected void RF0S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A1EspectaculoId = H000S2_A1EspectaculoId[0];
               AssignAttri(sPrefix, false, "A1EspectaculoId", StringUtil.LTrimStr( (decimal)(A1EspectaculoId), 4, 0));
               A10ClienteName = H000S2_A10ClienteName[0];
               A9ClienteId = H000S2_A9ClienteId[0];
               A30LugarSectorPrecio = H000S2_A30LugarSectorPrecio[0];
               A28LugarSectorName = H000S2_A28LugarSectorName[0];
               A27LugarSectorId = H000S2_A27LugarSectorId[0];
               A12ValorPorAsiento = H000S2_A12ValorPorAsiento[0];
               A11VentaId = H000S2_A11VentaId[0];
               A4LugarId = H000S2_A4LugarId[0];
               A10ClienteName = H000S2_A10ClienteName[0];
               A30LugarSectorPrecio = H000S2_A30LugarSectorPrecio[0];
               A28LugarSectorName = H000S2_A28LugarSectorName[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_VENTAID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A11VentaId), "ZZZ9"), context));
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Venta";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "espectaculoventawc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202288219211", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("espectaculoventawc.js", "?202288219211", false, true);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtValorPorAsiento_Internalname = sPrefix+"VALORPORASIENTO_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtValorPorAsiento_Internalname = sPrefix+"VALORPORASIENTO_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtValorPorAsiento_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A12ValorPorAsiento), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A12ValorPorAsiento), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtValorPorAsiento_Link,(string)"",(string)"",(string)"",(string)edtValorPorAsiento_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteName_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A10ClienteName), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A10ClienteName), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtClienteName_Link,(string)"",(string)"",(string)"",(string)edtClienteName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl20( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A10ClienteName), 4, 0, ".", "")));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EspectaculoId',fld:'vESPECTACULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E130S2',iparms:[{av:'A11VentaId',fld:'VENTAID',pic:'ZZZ9',hsh:true},{av:'A9ClienteId',fld:'CLIENTEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtValorPorAsiento_Link',ctrl:'VALORPORASIENTO',prop:'Link'},{av:'edtClienteName_Link',ctrl:'CLIENTENAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110S2',iparms:[{av:'A11VentaId',fld:'VENTAID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EspectaculoId',fld:'vESPECTACULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EspectaculoId',fld:'vESPECTACULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EspectaculoId',fld:'vESPECTACULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EspectaculoId',fld:'vESPECTACULOID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         H000S2_A1EspectaculoId = new short[1] ;
         H000S2_A10ClienteName = new short[1] ;
         H000S2_A9ClienteId = new short[1] ;
         H000S2_A30LugarSectorPrecio = new short[1] ;
         H000S2_A28LugarSectorName = new string[] {""} ;
         H000S2_A27LugarSectorId = new short[1] ;
         H000S2_A12ValorPorAsiento = new short[1] ;
         H000S2_A11VentaId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.espectaculoventawc__default(),
            new Object[][] {
                new Object[] {
               H000S2_A4LugarId, H000S2_A1EspectaculoId, H000S2_A10ClienteName, H000S2_A9ClienteId, H000S2_A30LugarSectorPrecio, H000S2_A28LugarSectorName, H000S2_A27LugarSectorId, H000S2_A12ValorPorAsiento, H000S2_A11VentaId
               }
               , new Object[] {
      ...
      private short[] H000S2_A1EspectaculoId ;
      private short[] H000S2_A10ClienteName ;
      private short[] H000S2_A9ClienteId ;
      private short[] H000S2_A30LugarSectorPrecio ;
      private string[] H000S2_A28LugarSectorName ;
      private short[] H000S2_A27LugarSectorId ;
      private short[] H000S2_A12ValorPorAsiento ;
      private short[] H000S2_A11VentaId ;
   ...
   public class espectaculoventawc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000S2", "SELECT T2.[LugarId], T1.[EspectaculoId], T3.[ClienteName], T1.[ClienteId], T4.[LugarSectorPrecio], T4.[LugarSectorName], T1.[LugarSectorId], T1.[ValorPorAsiento], T1.[VentaId] FROM ((([Venta] T1 INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) LEFT JOIN [LugarSector] T4 ON T4.[LugarId] = T2.[LugarId] AND T4.[LugarSectorId] = T1.[LugarSectorId]) INNER JOIN [Cliente] T3 ON T3.[ClienteId] = T1.[ClienteId]) WHERE T1.[EspectaculoId] = @AV6EspectaculoId ORDER BY T1.[EspectaculoId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000S3", "SELECT COUNT(*) FROM ((([Venta] T1 INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) LEFT JOIN [LugarSector] T3 ON T3.[LugarId] = T2.[LugarId] AND T3.[LugarSectorId] = T1.[LugarSectorId]) INNER JOIN [Cliente] T4 ON T4.[ClienteId] = T1.[ClienteId]) WHERE T1.[EspectaculoId] = @AV6EspectaculoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
