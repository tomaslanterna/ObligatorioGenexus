...
namespace GeneXus.Programs {
   public class tipoespectaculo_dataprovider : GXProcedure
   {
      ...
      {
         this.AV2ReturnValue = new GXBCCollection<SdtTipoEspectaculo>( context, "TipoEspectaculo", "Obligatorio1v2") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBCCollection<SdtTipoEspectaculo> aP0_ReturnValue )
      {
         ...
         objtipoespectaculo_dataprovider.AV2ReturnValue = new GXBCCollection<SdtTipoEspectaculo>( context, "TipoEspectaculo", "Obligatorio1v2") ;
      ...
      {
         AV2ReturnValue = new GXBCCollection<SdtTipoEspectaculo>( context, "TipoEspectaculo", "Obligatorio1v2");
         /* GeneXus formulas. */
         context.Gx_err = 0;
      }
