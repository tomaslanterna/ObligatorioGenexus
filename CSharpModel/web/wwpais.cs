...
namespace GeneXus.Programs {
   public class wwpais : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwpais( )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11PaisName, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228111850036", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vPAISNAME", AV11PaisName);
         /* Send saved values. */
      ...
      protected void WB0W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Pais", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWPais.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPais.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavPaisname_Internalname, "Pais Name", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavPaisname_Internalname, AV11PaisName, StringUtil.RTrim( context.localUtil.Format( AV11PaisName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavPaisname_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavPaisname_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWPais.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              n39PaisFlag = false;
                              AssignProp("", false, edtPaisFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A39PaisFlag)) ? A40000PaisFlag_GXI : context.convertURL( context.PathToRelativeUrl( A39PaisFlag))), !bGXsfl_25_Refreshing);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Paisname Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vPAISNAME"), AV11PaisName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0W2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavPaisname_Internalname;
      ...
      protected void RF0W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11PaisName = StringUtil.Concat( StringUtil.RTrim( AV11PaisName), "%", "");
            /* Using cursor H000W2 */
            pr_default.execute(0, new Object[] {lV11PaisName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A40000PaisFlag_GXI = H000W2_A40000PaisFlag_GXI[0];
               n40000PaisFlag_GXI = H000W2_n40000PaisFlag_GXI[0];
               AssignProp("", false, edtPaisFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A39PaisFlag)) ? A40000PaisFlag_GXI : context.convertURL( context.PathToRelativeUrl( A39PaisFlag))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtPaisFlag_Internalname, "SrcSet", context.GetImageSrcSet( A39PaisFlag), true);
               A6PaisName = H000W2_A6PaisName[0];
               A3PaisId = H000W2_A3PaisId[0];
               A39PaisFlag = H000W2_A39PaisFlag[0];
               n39PaisFlag = H000W2_n39PaisFlag[0];
               AssignProp("", false, edtPaisFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A39PaisFlag)) ? A40000PaisFlag_GXI : context.convertURL( context.PathToRelativeUrl( A39PaisFlag))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtPaisFlag_Internalname, "SrcSet", context.GetImageSrcSet( A39PaisFlag), true);
               E140W2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PAISID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A3PaisId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11PaisName = StringUtil.Concat( StringUtil.RTrim( AV11PaisName), "%", "");
         /* Using cursor H000W3 */
         pr_default.execute(1, new Object[] {lV11PaisName});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11PaisName = GridState.FilterValues("Paisname");
            AssignAttri("", false, "AV11PaisName", AV11PaisName);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("PaisName", AV11PaisName);
      }
      ...
      protected void STRUP0W0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11PaisName = cgiGet( edtavPaisname_Internalname);
            AssignAttri("", false, "AV11PaisName", AV11PaisName);
      ...
      private void E140W2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("pais.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A3PaisId,4,0))}, new string[] {"Mode","PaisId"}) ;
         edtavDelete_Link = formatLink("pais.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A3PaisId,4,0))}, new string[] {"Mode","PaisId"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228111850051", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpais.js", "?20228111850051", false, true);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtPaisFlag_Internalname = "PAISFLAG_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtPaisFlag_Internalname = "PAISFLAG_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisFlag_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)1,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn WWOptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A39PaisFlag_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl25( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A39PaisFlag));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavPaisname_Internalname = "vPAISNAME";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavPaisname_Jsonclick = "";
         edtavPaisname_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaisName',fld:'vPAISNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140W2',iparms:[{av:'A3PaisId',fld:'PAISID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtPaisName_Link',ctrl:'PAISNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110W2',iparms:[{av:'A3PaisId',fld:'PAISID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaisName',fld:'vPAISNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaisName',fld:'vPAISNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaisName',fld:'vPAISNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaisName',fld:'vPAISNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11PaisName = "";
         H000W2_A40000PaisFlag_GXI = new string[] {""} ;
         H000W2_n40000PaisFlag_GXI = new bool[] {false} ;
         H000W2_A6PaisName = new string[] {""} ;
         H000W2_A3PaisId = new short[1] ;
         H000W2_A39PaisFlag = new string[] {""} ;
         H000W2_n39PaisFlag = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpais__default(),
            new Object[][] {
                new Object[] {
               H000W2_A40000PaisFlag_GXI, H000W2_n40000PaisFlag_GXI, H000W2_A6PaisName, H000W2_A3PaisId, H000W2_A39PaisFlag, H000W2_n39PaisFlag
               }
               , new Object[] {
      ...
      private int edtavPaisname_Enabled ;
      ...
      private string edtavPaisname_Internalname ;
      private string edtavPaisname_Jsonclick ;
      ...
      private string[] H000W2_A40000PaisFlag_GXI ;
      private bool[] H000W2_n40000PaisFlag_GXI ;
      private string[] H000W2_A6PaisName ;
      private short[] H000W2_A3PaisId ;
      private string[] H000W2_A39PaisFlag ;
      private bool[] H000W2_n39PaisFlag ;
   ...
   public class wwpais__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A6PaisName )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11PaisName)) )
         {
            AddWhere(sWhereString, "([PaisName] like @lV11PaisName)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [PaisName]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11PaisName",GXType.NVarChar,40,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000W2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000W2,1, GxCacheFrequency.OFF ,true,false )
