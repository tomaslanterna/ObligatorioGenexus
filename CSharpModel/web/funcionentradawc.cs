...
namespace GeneXus.Programs {
   public class funcionentradawc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public funcionentradawc( )
      {
      ...
      public funcionentradawc( IGxContext context )
      {
      ...
      public void execute( short aP0_FuncionId )
      {
         this.AV6FuncionId = aP0_FuncionId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "FuncionId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6FuncionId = (short)(NumberUtil.Val( GetPar( "FuncionId"), "."));
                  AssignAttri(sPrefix, false, "AV6FuncionId", StringUtil.LTrimStr( (decimal)(AV6FuncionId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6FuncionId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6FuncionId, AV12Update, AV13Delete, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Funcion Entrada WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228921401975", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("funcionentradawc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6FuncionId,4,0))}, new string[] {"FuncionId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6FuncionId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6FuncionId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"PAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A3PaisId), 4, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vFUNCIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6FuncionId), 4, 0, ",", "")));
      ...
      {
         return "FuncionEntradaWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Funcion Entrada WC" ;
      }
      ...
      protected void WB170( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "funcionentradawc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_FuncionEntradaWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            GxWebStd.gx_label_element( context, edtFuncionId_Internalname, "Funcion Id", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtFuncionId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A15FuncionId), 4, 0, ",", "")), StringUtil.LTrim( ((edtFuncionId_Enabled!=0) ? context.localUtil.Format( (decimal)(A15FuncionId), "ZZZ9") : context.localUtil.Format( (decimal)(A15FuncionId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtFuncionId_Jsonclick, 0, "Attribute", "", "", "", "", edtFuncionId_Visible, edtFuncionId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_FuncionEntradaWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START172( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Funcion Entrada WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF172( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00173 */
            pr_default.execute(0, new Object[] {AV6FuncionId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_20_idx = 1;
            sGXsfl_20_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_20_idx), 4, 0), 4, "0");
            SubsflControlProps_202( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A1EspectaculoId = H00173_A1EspectaculoId[0];
               A3PaisId = H00173_A3PaisId[0];
               A4LugarId = H00173_A4LugarId[0];
               A7TipoEspectaculoId = H00173_A7TipoEspectaculoId[0];
               A15FuncionId = H00173_A15FuncionId[0];
               AssignAttri(sPrefix, false, "A15FuncionId", StringUtil.LTrimStr( (decimal)(A15FuncionId), 4, 0));
               A44EntradaPaisOrigenName = H00173_A44EntradaPaisOrigenName[0];
               A43EntradaPaisOrigenId = H00173_A43EntradaPaisOrigenId[0];
               A8TipoEspectaculoName = H00173_A8TipoEspectaculoName[0];
               A30LugarSectorPrecio = H00173_A30LugarSectorPrecio[0];
               A28LugarSectorName = H00173_A28LugarSectorName[0];
               A27LugarSectorId = H00173_A27LugarSectorId[0];
               n27LugarSectorId = H00173_n27LugarSectorId[0];
               A16EspectaculoFecha = H00173_A16EspectaculoFecha[0];
               A42EntradaFecha = H00173_A42EntradaFecha[0];
               A5LugarName = H00173_A5LugarName[0];
               A6PaisName = H00173_A6PaisName[0];
               A10ClienteName = H00173_A10ClienteName[0];
               A9ClienteId = H00173_A9ClienteId[0];
               A23EntradaId = H00173_A23EntradaId[0];
               A29LugarSectorCantidad = H00173_A29LugarSectorCantidad[0];
               A37LugarSectorVendidas = H00173_A37LugarSectorVendidas[0];
               n37LugarSectorVendidas = H00173_n37LugarSectorVendidas[0];
               A1EspectaculoId = H00173_A1EspectaculoId[0];
               A4LugarId = H00173_A4LugarId[0];
               A7TipoEspectaculoId = H00173_A7TipoEspectaculoId[0];
               A16EspectaculoFecha = H00173_A16EspectaculoFecha[0];
      ...
      {
         /* Using cursor H00175 */
         pr_default.execute(1, new Object[] {AV6FuncionId});
      ...
      protected void STRUP170( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6FuncionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6FuncionId"), ",", "."));
      ...
      protected void E12172( )
      {
         ...
         AV13Delete = "Eliminar";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtFuncionId_Visible = 0;
         AssignProp(sPrefix, false, edtFuncionId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtFuncionId_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "FuncionId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6FuncionId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6FuncionId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6FuncionId", StringUtil.LTrimStr( (decimal)(AV6FuncionId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6FuncionId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "funcionentradawc", GetJustCreated( ));
         ...
         {
            AV6FuncionId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6FuncionId", StringUtil.LTrimStr( (decimal)(AV6FuncionId), 4, 0));
         }
         wcpOAV6FuncionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6FuncionId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV6FuncionId != wcpOAV6FuncionId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6FuncionId = AV6FuncionId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6FuncionId = cgiGet( sPrefix+"AV6FuncionId_CTRL");
         if ( StringUtil.Len( sCtrlAV6FuncionId) > 0 )
         {
            AV6FuncionId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6FuncionId), ",", "."));
            AssignAttri(sPrefix, false, "AV6FuncionId", StringUtil.LTrimStr( (decimal)(AV6FuncionId), 4, 0));
         }
         else
         {
            AV6FuncionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6FuncionId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6FuncionId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6FuncionId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6FuncionId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6FuncionId_CTRL", StringUtil.RTrim( sCtrlAV6FuncionId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2022892140206", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("funcionentradawc.js", "?2022892140206", false, true);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtClienteName_Internalname = sPrefix+"CLIENTENAME_"+sGXsfl_20_idx;
         edtPaisName_Internalname = sPrefix+"PAISNAME_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtClienteName_Internalname = sPrefix+"CLIENTENAME_"+sGXsfl_20_fel_idx;
         edtPaisName_Internalname = sPrefix+"PAISNAME_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A9ClienteId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A9ClienteId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtClienteId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6FuncionId',fld:'vFUNCIONID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E13172',iparms:[{av:'A23EntradaId',fld:'ENTRADAID',pic:'ZZZ9',hsh:true},{av:'A9ClienteId',fld:'CLIENTEID',pic:'ZZZ9'},{av:'A3PaisId',fld:'PAISID',pic:'ZZZ9'},{av:'A4LugarId',fld:'LUGARID',pic:'ZZZ9'},{av:'A7TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtClienteName_Link',ctrl:'CLIENTENAME',prop:'Link'},{av:'edtPaisName_Link',ctrl:'PAISNAME',prop:'Link'},{av:'edtLugarName_Link',ctrl:'LUGARNAME',prop:'Link'},{av:'edtEntradaFecha_Link',ctrl:'ENTRADAFECHA',prop:'Link'},{av:'edtTipoEspectaculoName_Link',ctrl:'TIPOESPECTACULONAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11172',iparms:[{av:'A23EntradaId',fld:'ENTRADAID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6FuncionId',fld:'vFUNCIONID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6FuncionId',fld:'vFUNCIONID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6FuncionId',fld:'vFUNCIONID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6FuncionId',fld:'vFUNCIONID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00173_A1EspectaculoId = new short[1] ;
         H00173_A3PaisId = new short[1] ;
         H00173_A4LugarId = new short[1] ;
         H00173_A7TipoEspectaculoId = new short[1] ;
         H00173_A15FuncionId = new short[1] ;
         H00173_A44EntradaPaisOrigenName = new string[] {""} ;
         H00173_A43EntradaPaisOrigenId = new short[1] ;
         H00173_A8TipoEspectaculoName = new string[] {""} ;
         H00173_A30LugarSectorPrecio = new short[1] ;
         H00173_A28LugarSectorName = new string[] {""} ;
         H00173_A27LugarSectorId = new short[1] ;
         H00173_n27LugarSectorId = new bool[] {false} ;
         H00173_A16EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H00173_A42EntradaFecha = new DateTime[] {DateTime.MinValue} ;
         H00173_A5LugarName = new string[] {""} ;
         H00173_A6PaisName = new string[] {""} ;
         H00173_A10ClienteName = new string[] {""} ;
         H00173_A9ClienteId = new short[1] ;
         H00173_A23EntradaId = new short[1] ;
         H00173_A29LugarSectorCantidad = new short[1] ;
         H00173_A37LugarSectorVendidas = new short[1] ;
         H00173_n37LugarSectorVendidas = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.funcionentradawc__default(),
            new Object[][] {
                new Object[] {
               H00173_A1EspectaculoId, H00173_A3PaisId, H00173_A4LugarId, H00173_A7TipoEspectaculoId, H00173_A15FuncionId, H00173_A44EntradaPaisOrigenName, H00173_A43EntradaPaisOrigenId, H00173_A8TipoEspectaculoName, H00173_A30LugarSectorPrecio, H00173_A28LugarSectorName,
               H00173_A27LugarSectorId, H00173_n27LugarSectorId, H00173_A16EspectaculoFecha, H00173_A42EntradaFecha, H00173_A5LugarName, H00173_A6PaisName, H00173_A10ClienteName, H00173_A9ClienteId, H00173_A23EntradaId, H00173_A29LugarSectorCantidad,
               H00173_A37LugarSectorVendidas, H00173_n37LugarSectorVendidas
               }
               , new Object[] {
      ...
      private short AV6FuncionId ;
      private short wcpOAV6FuncionId ;
      ...
      private int edtFuncionId_Visible ;
      ...
      private string sCtrlAV6FuncionId ;
      ...
      private short[] H00173_A1EspectaculoId ;
      private short[] H00173_A3PaisId ;
      private short[] H00173_A4LugarId ;
      private short[] H00173_A7TipoEspectaculoId ;
      private short[] H00173_A15FuncionId ;
      private string[] H00173_A44EntradaPaisOrigenName ;
      private short[] H00173_A43EntradaPaisOrigenId ;
      private string[] H00173_A8TipoEspectaculoName ;
      private short[] H00173_A30LugarSectorPrecio ;
      private string[] H00173_A28LugarSectorName ;
      private short[] H00173_A27LugarSectorId ;
      private bool[] H00173_n27LugarSectorId ;
      private DateTime[] H00173_A16EspectaculoFecha ;
      private DateTime[] H00173_A42EntradaFecha ;
      private string[] H00173_A5LugarName ;
      private string[] H00173_A6PaisName ;
      private string[] H00173_A10ClienteName ;
      private short[] H00173_A9ClienteId ;
      private short[] H00173_A23EntradaId ;
      private short[] H00173_A29LugarSectorCantidad ;
      private short[] H00173_A37LugarSectorVendidas ;
      private bool[] H00173_n37LugarSectorVendidas ;
   ...
   public class funcionentradawc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6FuncionId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00173", "SELECT T2.[EspectaculoId], T8.[PaisId], T3.[LugarId], T3.[TipoEspectaculoId], T1.[FuncionId], T1.[EntradaPaisOrigenName], T1.[EntradaPaisOrigenId], T5.[TipoEspectaculoName], T6.[LugarSectorPrecio], T6.[LugarSectorName], T1.[LugarSectorId], T3.[EspectaculoFecha], T1.[EntradaFecha], T4.[LugarName], T9.[PaisName], T8.[ClienteName], T1.[ClienteId], T1.[EntradaId], T6.[LugarSectorCantidad], COALESCE( T7.[LugarSectorVendidas], 0) AS LugarSectorVendidas FROM (((((((([Entrada] T1 INNER JOIN [Funcion] T2 ON T2.[FuncionId] = T1.[FuncionId]) INNER JOIN [Espectaculo] T3 ON T3.[EspectaculoId] = T2.[EspectaculoId]) INNER JOIN [Lugar] T4 ON T4.[LugarId] = T3.[LugarId]) INNER JOIN [TipoEspectaculo] T5 ON T5.[TipoEspectaculoId] = T3.[TipoEspectaculoId]) LEFT JOIN [LugarSector] T6 ON T6.[LugarId] = T3.[LugarId] AND T6.[LugarSectorId] = T1.[LugarSectorId]) LEFT JOIN (SELECT COUNT(*) AS LugarSectorVendidas, T10.[LugarSectorId], T11.[EspectaculoId] FROM ([Entrada] T10 INNER JOIN [Funcion] T11 ON T11.[FuncionId] = T10.[FuncionId]) GROUP BY T10.[LugarSectorId], T11.[EspectaculoId] ) T7 ON T7.[LugarSectorId] = T1.[LugarSectorId] AND T7.[EspectaculoId] = T2.[EspectaculoId]) INNER JOIN [Cliente] T8 ON T8.[ClienteId] = T1.[ClienteId]) INNER JOIN [Pais] T9 ON T9.[PaisId] = T8.[PaisId]) WHERE T1.[FuncionId] = @AV6FuncionId ORDER BY T1.[FuncionId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00173,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00175", "SELECT COUNT(*) FROM (((((((([Entrada] T1 INNER JOIN [Funcion] T4 ON T4.[FuncionId] = T1.[FuncionId]) INNER JOIN [Espectaculo] T5 ON T5.[EspectaculoId] = T4.[EspectaculoId]) INNER JOIN [Lugar] T6 ON T6.[LugarId] = T5.[LugarId]) INNER JOIN [TipoEspectaculo] T7 ON T7.[TipoEspectaculoId] = T5.[TipoEspectaculoId]) LEFT JOIN [LugarSector] T8 ON T8.[LugarId] = T5.[LugarId] AND T8.[LugarSectorId] = T1.[LugarSectorId]) LEFT JOIN (SELECT COUNT(*) AS LugarSectorVendidas, T10.[LugarSectorId], T11.[EspectaculoId] FROM ([Entrada] T10 INNER JOIN [Funcion] T11 ON T11.[FuncionId] = T10.[FuncionId]) GROUP BY T10.[LugarSectorId], T11.[EspectaculoId] ) T9 ON T9.[LugarSectorId] = T1.[LugarSectorId] AND T9.[EspectaculoId] = T4.[EspectaculoId]) INNER JOIN [Cliente] T2 ON T2.[ClienteId] = T1.[ClienteId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T2.[PaisId]) WHERE T1.[FuncionId] = @AV6FuncionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00175,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
