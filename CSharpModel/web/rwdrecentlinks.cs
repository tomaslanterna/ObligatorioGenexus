...
namespace GeneXus.Programs {
   public class rwdrecentlinks : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void gxnrLinks_newrow_invoke( )
      {
      ...
      protected void gxgrLinks_refresh_invoke( )
      {
         AV6FormCaption = GetPar( "FormCaption");
         sPrefix = GetPar( "sPrefix");
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202288219643", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB050( )
      {
         ...
         if ( wbEnd == 8 )
         {
            ...
            else
            {
               ...
               context.httpAjaxContext.ajax_rsp_assign_grid(sPrefix+"_"+"Links", LinksContainer, subLinks_Internalname);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202288219653", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("rwdrecentlinks.js", "?202288219653", false, true);
      ...
      protected void StartGridControl8( )
      {
         if ( LinksContainer.GetWrapped() == 1 )
         {
