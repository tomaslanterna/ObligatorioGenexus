...
namespace GeneXus.Programs {
   public class gx0030 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV8pPaisId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV6cPaisId = (short)(NumberUtil.Val( GetPar( "cPaisId"), "."));
         AV7cPaisName = GetPar( "cPaisName");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cPaisId, AV7cPaisName) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCPAISNAME", AV7cPaisName);
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "PAISNAMEFILTERCONTAINER_Class", StringUtil.RTrim( divPaisnamefiltercontainer_Class));
      }
      ...
      protected void WB1J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblpaisidfilter_Internalname, "Pais Id", "", "", lblLblpaisidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e111j1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0030.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCpaisid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cPaisId), 4, 0, ",", "")), StringUtil.LTrim( ((edtavCpaisid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cPaisId), "ZZZ9") : context.localUtil.Format( (decimal)(AV6cPaisId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCpaisid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCpaisid_Visible, edtavCpaisid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0030.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divPaisnamefiltercontainer_Internalname, 1, 0, "px", 0, "px", divPaisnamefiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblpaisnamefilter_Internalname, "Pais Name", "", "", lblLblpaisnamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e121j1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0030.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCpaisname_Internalname, "Pais Name", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 26,'',false,'" + sGXsfl_34_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCpaisname_Internalname, AV7cPaisName, StringUtil.RTrim( context.localUtil.Format( AV7cPaisName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCpaisname_Jsonclick, 0, "Attribute", "", "", "", "", edtavCpaisname_Visible, edtavCpaisname_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Gx0030.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e131j1_client"+"'", TempTags, "", 2, "HLP_Gx0030.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              A39PaisFlag = cgiGet( edtPaisFlag_Internalname);
                              n39PaisFlag = false;
                              AssignProp("", false, edtPaisFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A39PaisFlag)) ? A40000PaisFlag_GXI : context.convertURL( context.PathToRelativeUrl( A39PaisFlag))), !bGXsfl_34_Refreshing);
                              AssignProp("", false, edtPaisFlag_Internalname, "SrcSet", context.GetImageSrcSet( A39PaisFlag), true);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       /* Set Refresh If Cpaisname Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCPAISNAME"), AV7cPaisName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF1J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV7cPaisName = StringUtil.Concat( StringUtil.RTrim( AV7cPaisName), "%", "");
            /* Using cursor H001J2 */
            pr_default.execute(0, new Object[] {AV6cPaisId, lV7cPaisName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_34_idx = 1;
            sGXsfl_34_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_34_idx), 4, 0), 4, "0");
            SubsflControlProps_342( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A40000PaisFlag_GXI = H001J2_A40000PaisFlag_GXI[0];
               n40000PaisFlag_GXI = H001J2_n40000PaisFlag_GXI[0];
               AssignProp("", false, edtPaisFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A39PaisFlag)) ? A40000PaisFlag_GXI : context.convertURL( context.PathToRelativeUrl( A39PaisFlag))), !bGXsfl_34_Refreshing);
               AssignProp("", false, edtPaisFlag_Internalname, "SrcSet", context.GetImageSrcSet( A39PaisFlag), true);
               A6PaisName = H001J2_A6PaisName[0];
               A3PaisId = H001J2_A3PaisId[0];
               A39PaisFlag = H001J2_A39PaisFlag[0];
               n39PaisFlag = H001J2_n39PaisFlag[0];
               AssignProp("", false, edtPaisFlag_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A39PaisFlag)) ? A40000PaisFlag_GXI : context.convertURL( context.PathToRelativeUrl( A39PaisFlag))), !bGXsfl_34_Refreshing);
               AssignProp("", false, edtPaisFlag_Internalname, "SrcSet", context.GetImageSrcSet( A39PaisFlag), true);
               /* Execute user event: Load */
               E151J2 ();
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV7cPaisName = StringUtil.Concat( StringUtil.RTrim( AV7cPaisName), "%", "");
         /* Using cursor H001J3 */
         pr_default.execute(1, new Object[] {AV6cPaisId, lV7cPaisName});
      ...
      protected void STRUP1J0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               AV6cPaisId = (short)(context.localUtil.CToN( cgiGet( edtavCpaisid_Internalname), ",", "."));
               AssignAttri("", false, "AV6cPaisId", StringUtil.LTrimStr( (decimal)(AV6cPaisId), 4, 0));
            }
            AV7cPaisName = cgiGet( edtavCpaisname_Internalname);
            AssignAttri("", false, "AV7cPaisName", AV7cPaisName);
      ...
      protected void SubsflControlProps_342( )
      {
         ...
         edtPaisName_Internalname = "PAISNAME_"+sGXsfl_34_idx;
         edtPaisFlag_Internalname = "PAISFLAG_"+sGXsfl_34_idx;
      }
      ...
      protected void SubsflControlProps_fel_342( )
      {
         ...
         edtPaisName_Internalname = "PAISNAME_"+sGXsfl_34_fel_idx;
         edtPaisFlag_Internalname = "PAISFLAG_"+sGXsfl_34_fel_idx;
      }
      ...
      protected void sendrow_342( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtPaisName_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A3PaisId), 4, 0, ",", "")))+"'"+"]);";
            AssignProp("", false, edtPaisName_Internalname, "Link", edtPaisName_Link, !bGXsfl_34_Refreshing);
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisName_Internalname,(string)A6PaisName,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtPaisName_Link,(string)"",(string)"",(string)"",(string)edtPaisName_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)34,(short)1,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
            ...
            Grid1Row.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisFlag_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)1,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn OptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A39PaisFlag_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
      ...
      protected void StartGridControl34( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", A6PaisName);
            Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtPaisName_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", context.convertURL( A39PaisFlag));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      protected void init_default_properties( )
      {
         ...
         lblLblpaisnamefilter_Internalname = "LBLPAISNAMEFILTER";
         edtavCpaisname_Internalname = "vCPAISNAME";
         divPaisnamefiltercontainer_Internalname = "PAISNAMEFILTERCONTAINER";
         divAdvancedcontainer_Internalname = "ADVANCEDCONTAINER";
         bttBtntoggle_Internalname = "BTNTOGGLE";
         edtavLinkselection_Internalname = "vLINKSELECTION";
         edtPaisId_Internalname = "PAISID";
         edtPaisName_Internalname = "PAISNAME";
         edtPaisFlag_Internalname = "PAISFLAG";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavCpaisname_Jsonclick = "";
         edtavCpaisname_Enabled = 1;
         edtavCpaisname_Visible = 1;
         edtavCpaisid_Jsonclick = "";
         edtavCpaisid_Enabled = 1;
         edtavCpaisid_Visible = 1;
         divPaisnamefiltercontainer_Class = "AdvancedContainerItem";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPaisId',fld:'vCPAISID',pic:'ZZZ9'},{av:'AV7cPaisName',fld:'vCPAISNAME',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E131J1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLPAISIDFILTER.CLICK","{handler:'E111J1',iparms:[{av:'divPaisidfiltercontainer_Class',ctrl:'PAISIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPAISNAMEFILTER.CLICK","{handler:'E121J1',iparms:[{av:'divPaisnamefiltercontainer_Class',ctrl:'PAISNAMEFILTERCONTAINER',prop:'Class'}]");
         setEventMetadata("LBLPAISNAMEFILTER.CLICK",",oparms:[{av:'divPaisnamefiltercontainer_Class',ctrl:'PAISNAMEFILTERCONTAINER',prop:'Class'},{av:'edtavCpaisname_Visible',ctrl:'vCPAISNAME',prop:'Visible'}]}");
         setEventMetadata("ENTER","{handler:'E161J2',iparms:[{av:'A3PaisId',fld:'PAISID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pPaisId',fld:'vPPAISID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPaisId',fld:'vCPAISID',pic:'ZZZ9'},{av:'AV7cPaisName',fld:'vCPAISNAME',pic:''}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPaisId',fld:'vCPAISID',pic:'ZZZ9'},{av:'AV7cPaisName',fld:'vCPAISNAME',pic:''}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPaisId',fld:'vCPAISID',pic:'ZZZ9'},{av:'AV7cPaisName',fld:'vCPAISNAME',pic:''}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPaisId',fld:'vCPAISID',pic:'ZZZ9'},{av:'AV7cPaisName',fld:'vCPAISNAME',pic:''}]");
         setEventMetadata("GRID1_LASTPAGE",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Paisflag',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         TempTags = "";
         lblLblpaisnamefilter_Jsonclick = "";
         ClassString = "";
         StyleString = "";
         ...
         scmdbuf = "";
         lV7cPaisName = "";
         H001J2_A40000PaisFlag_GXI = new string[] {""} ;
         H001J2_n40000PaisFlag_GXI = new bool[] {false} ;
         H001J2_A6PaisName = new string[] {""} ;
         H001J2_A3PaisId = new short[1] ;
         H001J2_A39PaisFlag = new string[] {""} ;
         H001J2_n39PaisFlag = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0030__default(),
            new Object[][] {
                new Object[] {
               H001J2_A40000PaisFlag_GXI, H001J2_n40000PaisFlag_GXI, H001J2_A6PaisName, H001J2_A3PaisId, H001J2_A39PaisFlag, H001J2_n39PaisFlag
               }
               , new Object[] {
      ...
      private int edtavCpaisname_Visible ;
      private int edtavCpaisname_Enabled ;
      ...
      private string divPaisnamefiltercontainer_Class ;
      ...
      private string divPaisnamefiltercontainer_Internalname ;
      private string lblLblpaisnamefilter_Internalname ;
      private string lblLblpaisnamefilter_Jsonclick ;
      private string edtavCpaisname_Internalname ;
      private string edtavCpaisname_Jsonclick ;
      ...
      private string edtPaisFlag_Internalname ;
      ...
      private string[] H001J2_A40000PaisFlag_GXI ;
      private bool[] H001J2_n40000PaisFlag_GXI ;
      private string[] H001J2_A6PaisName ;
      private short[] H001J2_A3PaisId ;
      private string[] H001J2_A39PaisFlag ;
      private bool[] H001J2_n39PaisFlag ;
   ...
   public class gx0030__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cPaisId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [PaisFlag_GXI], [PaisName], [PaisId], [PaisFlag]";
         sFromString = " FROM [Pais]";
         sOrderString = "";
         AddWhere(sWhereString, "([PaisId] >= @AV6cPaisId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV7cPaisName)) )
         {
            AddWhere(sWhereString, "([PaisName] like @lV7cPaisName)");
         }
         else
         {
            GXv_int1[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001J2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] );
               case 1 :
                     return conditional_H001J3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV7cPaisName",GXType.NVarChar,40,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001J2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001J2,1, GxCacheFrequency.OFF ,false,false )
