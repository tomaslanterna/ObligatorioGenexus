...
namespace GeneXus.Programs {
   public class viewcliente : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewcliente( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ClienteId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12ClienteId", StringUtil.LTrimStr( (decimal)(AV12ClienteId), 4, 0));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228822351591", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("ClienteName", StringUtil.RTrim( context.localUtil.Format( A10ClienteName, "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCLIENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12ClienteId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCLIENTEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ClienteId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewcliente.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ClienteId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ClienteId","TabCode"})  ;
      }
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Cliente Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Clientes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewCliente.htm");
            ...
            GxWebStd.gx_label_element( context, edtClienteName_Internalname, "Name", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtClienteName_Internalname, A10ClienteName, StringUtil.RTrim( context.localUtil.Format( A10ClienteName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClienteName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtClienteName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_ViewCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblVenta_title_Internalname, "Venta", "", "", lblVenta_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCliente.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0038"+"", StringUtil.RTrim( WebComp_Ventawc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblEntrada_title_Internalname, "Entrada", "", "", lblEntrada_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCliente.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0046"+"", StringUtil.RTrim( WebComp_Entradawc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 38 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Ventawc_Component) != 0 )
                           {
                              WebComp_Ventawc.componentprocess("W0038", "", sEvt);
                           }
                           WebComp_Ventawc_Component = OldVentawc;
                        }
                        else if ( nCmpId == 46 )
                        {
                           OldEntradawc = cgiGet( "W0046");
                           ...
                           if ( StringUtil.Len( WebComp_Entradawc_Component) != 0 )
                           {
                              WebComp_Entradawc.componentprocess("W0046", "", sEvt);
                           }
                           WebComp_Entradawc_Component = OldEntradawc;
                        }
                     }
      ...
      protected void RF0D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A9ClienteId = H000D2_A9ClienteId[0];
               A10ClienteName = H000D2_A10ClienteName[0];
      ...
      protected void STRUP0D0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ClienteId = (short)(context.localUtil.CToN( cgiGet( "vCLIENTEID"), ",", "."));
      ...
      protected void E110D2( )
      {
         ...
         {
            A9ClienteId = H000D3_A9ClienteId[0];
            A10ClienteName = H000D3_A10ClienteName[0];
            AssignAttri("", false, "A10ClienteName", A10ClienteName);
            AV16GXLvl6 = 1;
            Form.Caption = A10ClienteName;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(short)AV12ClienteId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Venta") == 0 ) )
         {
            ...
            if ( true )
            {
               bDynCreated_Ventawc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Ventawc_Component), StringUtil.Lower( "ClienteVentaWC")) != 0 )
            {
               WebComp_Ventawc = getWebComponent(GetType(), "GeneXus.Programs", "clienteventawc", new Object[] {context} );
               WebComp_Ventawc.ComponentInit();
               WebComp_Ventawc.Name = "ClienteVentaWC";
               WebComp_Ventawc_Component = "ClienteVentaWC";
            }
            if ( StringUtil.Len( WebComp_Ventawc_Component) != 0 )
            {
               WebComp_Ventawc.setjustcreated();
               WebComp_Ventawc.componentprepare(new Object[] {(string)"W0038",(string)"",(short)AV12ClienteId});
               WebComp_Ventawc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Ventawc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0038"+"");
               WebComp_Ventawc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Entrada") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Entradawc_Component), StringUtil.Lower( "ClienteEntradaWC")) != 0 )
            {
               WebComp_Entradawc = getWebComponent(GetType(), "GeneXus.Programs", "clienteentradawc", new Object[] {context} );
               WebComp_Entradawc.ComponentInit();
               WebComp_Entradawc.Name = "ClienteEntradaWC";
               WebComp_Entradawc_Component = "ClienteEntradaWC";
            }
            if ( StringUtil.Len( WebComp_Entradawc_Component) != 0 )
            {
               WebComp_Entradawc.setjustcreated();
               WebComp_Entradawc.componentprepare(new Object[] {(string)"W0046",(string)"",(short)AV12ClienteId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12ClienteId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12ClienteId", StringUtil.LTrimStr( (decimal)(AV12ClienteId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCLIENTEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ClienteId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2022882235168", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcliente.js", "?2022882235168", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12ClienteId',fld:'vCLIENTEID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A10ClienteName',fld:'CLIENTENAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000D2_A9ClienteId = new short[1] ;
         H000D2_A10ClienteName = new string[] {""} ;
         hsh = "";
         H000D3_A9ClienteId = new short[1] ;
         H000D3_A10ClienteName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcliente__default(),
            new Object[][] {
                new Object[] {
               H000D2_A9ClienteId, H000D2_A10ClienteName
               }
               , new Object[] {
               H000D3_A9ClienteId, H000D3_A10ClienteName
               }
            }
         );
      ...
      private bool bDynCreated_Ventawc ;
      ...
      private short[] H000D2_A9ClienteId ;
      private string[] H000D2_A10ClienteName ;
      private short[] H000D3_A9ClienteId ;
      private string[] H000D3_A10ClienteName ;
   ...
   public class viewcliente__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12ClienteId",GXType.Int16,4,0)
          };
          Object[] prmH000D3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000D2", "SELECT [ClienteId], [ClienteName] FROM [Cliente] WHERE [ClienteId] = @AV12ClienteId ORDER BY [ClienteId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000D3", "SELECT [ClienteId], [ClienteName] FROM [Cliente] WHERE [ClienteId] = @AV12ClienteId ORDER BY [ClienteId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
