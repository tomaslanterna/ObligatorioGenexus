...
namespace GeneXus.Programs {
   public class gx00g1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx00g1( )
      {
      ...
      public gx00g1( IGxContext context )
      {
      ...
      {
         this.AV8pEspectaculoId = aP0_pEspectaculoId;
         this.AV9pLugarSectorId = 0 ;
         executePrivate();
         aP1_pLugarSectorId=this.AV9pLugarSectorId;
      }
      ...
      {
         chkavClugarsectorestadosector = new GXCheckbox();
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV8pEspectaculoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV8pEspectaculoId", StringUtil.LTrimStr( (decimal)(AV8pEspectaculoId), 4, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9pLugarSectorId = (short)(NumberUtil.Val( GetPar( "pLugarSectorId"), "."));
                  AssignAttri("", false, "AV9pLugarSectorId", StringUtil.LTrimStr( (decimal)(AV9pLugarSectorId), 4, 0));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV7cLugarSectorEstadoSector = StringUtil.StrToBool( GetPar( "cLugarSectorEstadoSector"));
         AV8pEspectaculoId = (short)(NumberUtil.Val( GetPar( "pEspectaculoId"), "."));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cLugarSectorId, AV7cLugarSectorEstadoSector, AV8pEspectaculoId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022892329296", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00g1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pEspectaculoId,4,0)),UrlEncode(StringUtil.LTrimStr(AV9pLugarSectorId,4,0))}, new string[] {"pEspectaculoId","pLugarSectorId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCLUGARSECTORESTADOSECTOR", StringUtil.BoolToStr( AV7cLugarSectorEstadoSector));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_34", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_34), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vPESPECTACULOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8pEspectaculoId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vPLUGARSECTORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9pLugarSectorId), 4, 0, ",", "")));
      ...
      {
         return formatLink("gx00g1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pEspectaculoId,4,0)),UrlEncode(StringUtil.LTrimStr(AV9pLugarSectorId,4,0))}, new string[] {"pEspectaculoId","pLugarSectorId"})  ;
      }
      ...
      protected void WB1Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbllugarsectoridfilter_Internalname, "Lugar Sector Id", "", "", lblLbllugarsectoridfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e111z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00G1.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbllugarsectorestadosectorfilter_Internalname, "Lugar Sector Estado Sector", "", "", lblLbllugarsectorestadosectorfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e121z1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00G1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavClugarsectorestadosector_Internalname, "Lugar Sector Estado Sector", "col-sm-3 AttributeLabel", 0, true, "");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 26,'',false,'" + sGXsfl_34_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavClugarsectorestadosector_Internalname, StringUtil.BoolToStr( AV7cLugarSectorEstadoSector), "", "Lugar Sector Estado Sector", chkavClugarsectorestadosector.Visible, chkavClugarsectorestadosector.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(26, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,26);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e131z1_client"+"'", TempTags, "", 2, "HLP_Gx00G1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 34 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00G1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrToBool( cgiGet( "GXH_vCLUGARSECTORESTADOSECTOR")) != AV7cLugarSectorEstadoSector )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        ...
                                        bool AV7cLugarSectorEstadoSector ,
                                        short AV8pEspectaculoId )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      {
         AV7cLugarSectorEstadoSector = StringUtil.StrToBool( StringUtil.BoolToStr( AV7cLugarSectorEstadoSector));
         AssignAttri("", false, "AV7cLugarSectorEstadoSector", AV7cLugarSectorEstadoSector);
      }
      ...
      protected void RF1Z2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H001Z2 */
            pr_default.execute(0, new Object[] {AV8pEspectaculoId, AV6cLugarSectorId, AV7cLugarSectorEstadoSector, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_34_idx = 1;
            sGXsfl_34_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_34_idx), 4, 0), 4, "0");
            SubsflControlProps_342( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A1EspectaculoId = H001Z2_A1EspectaculoId[0];
               A41LugarSectorEstadoSector = H001Z2_A41LugarSectorEstadoSector[0];
               A27LugarSectorId = H001Z2_A27LugarSectorId[0];
               /* Execute user event: Load */
               E151Z2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_LUGARSECTORID"+"_"+sGXsfl_34_idx, GetSecureSignedToken( sGXsfl_34_idx, context.localUtil.Format( (decimal)(A27LugarSectorId), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         /* Using cursor H001Z3 */
         pr_default.execute(1, new Object[] {AV8pEspectaculoId, AV6cLugarSectorId, AV7cLugarSectorEstadoSector});
      ...
      protected void STRUP1Z0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV7cLugarSectorEstadoSector = StringUtil.StrToBool( cgiGet( chkavClugarsectorestadosector_Internalname));
            AssignAttri("", false, "AV7cLugarSectorEstadoSector", AV7cLugarSectorEstadoSector);
      ...
      protected void E141Z2( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Lugar Sector", "", "", "", "", "", "", "", "");
      ...
      protected void E161Z2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV9pLugarSectorId = A27LugarSectorId;
         AssignAttri("", false, "AV9pLugarSectorId", StringUtil.LTrimStr( (decimal)(AV9pLugarSectorId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV9pLugarSectorId});
         context.setWebReturnParmsMetadata(new Object[] {"AV9pLugarSectorId"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8pEspectaculoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV8pEspectaculoId", StringUtil.LTrimStr( (decimal)(AV8pEspectaculoId), 4, 0));
         AV9pLugarSectorId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV9pLugarSectorId", StringUtil.LTrimStr( (decimal)(AV9pLugarSectorId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228923292922", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00g1.js", "?20228923292922", false, true);
      ...
      protected void SubsflControlProps_342( )
      {
         ...
         edtLugarSectorId_Internalname = "LUGARSECTORID_"+sGXsfl_34_idx;
         chkLugarSectorEstadoSector_Internalname = "LUGARSECTORESTADOSECTOR_"+sGXsfl_34_idx;
         edtEspectaculoId_Internalname = "ESPECTACULOID_"+sGXsfl_34_idx;
      }

      protected void SubsflControlProps_fel_342( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_34_fel_idx;
         edtLugarSectorId_Internalname = "LUGARSECTORID_"+sGXsfl_34_fel_idx;
         chkLugarSectorEstadoSector_Internalname = "LUGARSECTORESTADOSECTOR_"+sGXsfl_34_fel_idx;
         edtEspectaculoId_Internalname = "ESPECTACULOID_"+sGXsfl_34_fel_idx;
      }
      ...
      protected void sendrow_342( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            GXCCtl = "LUGARSECTORESTADOSECTOR_" + sGXsfl_34_idx;
            chkLugarSectorEstadoSector.Name = GXCCtl;
            chkLugarSectorEstadoSector.WebTags = "";
            chkLugarSectorEstadoSector.Caption = "";
            AssignProp("", false, chkLugarSectorEstadoSector_Internalname, "TitleCaption", chkLugarSectorEstadoSector.Caption, !bGXsfl_34_Refreshing);
            ...
            Grid1Row.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkLugarSectorEstadoSector_Internalname,StringUtil.BoolToStr( A41LugarSectorEstadoSector),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn",(string)"",(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
      ...
      {
         chkavClugarsectorestadosector.Name = "vCLUGARSECTORESTADOSECTOR";
         chkavClugarsectorestadosector.WebTags = "";
         chkavClugarsectorestadosector.Caption = "";
         AssignProp("", false, chkavClugarsectorestadosector_Internalname, "TitleCaption", chkavClugarsectorestadosector.Caption, true);
         chkavClugarsectorestadosector.CheckedValue = "false";
         AV7cLugarSectorEstadoSector = StringUtil.StrToBool( StringUtil.BoolToStr( AV7cLugarSectorEstadoSector));
         AssignAttri("", false, "AV7cLugarSectorEstadoSector", AV7cLugarSectorEstadoSector);
         GXCCtl = "LUGARSECTORESTADOSECTOR_" + sGXsfl_34_idx;
         chkLugarSectorEstadoSector.Name = GXCCtl;
      ...
      protected void StartGridControl34( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", StringUtil.BoolToStr( A41LugarSectorEstadoSector));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         chkavClugarsectorestadosector_Internalname = "vCLUGARSECTORESTADOSECTOR";
      ...
      public override void initialize_properties( )
      {
         ...
         subGrid1_Header = "";
         chkavClugarsectorestadosector.Caption = "Lugar Sector Estado Sector";
         ...
         chkavClugarsectorestadosector.Enabled = 1;
         chkavClugarsectorestadosector.Visible = 1;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLugarSectorId',fld:'vCLUGARSECTORID',pic:'ZZZ9'},{av:'AV8pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'},{av:'AV7cLugarSectorEstadoSector',fld:'vCLUGARSECTORESTADOSECTOR',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E131Z1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLLUGARSECTORIDFILTER.CLICK","{handler:'E111Z1',iparms:[{av:'divLugarsectoridfiltercontainer_Class',ctrl:'LUGARSECTORIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLLUGARSECTORESTADOSECTORFILTER.CLICK","{handler:'E121Z1',iparms:[{av:'divLugarsectorestadosectorfiltercontainer_Class',ctrl:'LUGARSECTORESTADOSECTORFILTERCONTAINER',prop:'Class'}]");
         setEventMetadata("LBLLUGARSECTORESTADOSECTORFILTER.CLICK",",oparms:[{av:'divLugarsectorestadosectorfiltercontainer_Class',ctrl:'LUGARSECTORESTADOSECTORFILTERCONTAINER',prop:'Class'},{av:'chkavClugarsectorestadosector.Visible',ctrl:'vCLUGARSECTORESTADOSECTOR',prop:'Visible'}]}");
         setEventMetadata("ENTER","{handler:'E161Z2',iparms:[{av:'A27LugarSectorId',fld:'LUGARSECTORID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV9pLugarSectorId',fld:'vPLUGARSECTORID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLugarSectorId',fld:'vCLUGARSECTORID',pic:'ZZZ9'},{av:'AV8pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'},{av:'AV7cLugarSectorEstadoSector',fld:'vCLUGARSECTORESTADOSECTOR',pic:''}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLugarSectorId',fld:'vCLUGARSECTORID',pic:'ZZZ9'},{av:'AV8pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'},{av:'AV7cLugarSectorEstadoSector',fld:'vCLUGARSECTORESTADOSECTOR',pic:''}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLugarSectorId',fld:'vCLUGARSECTORID',pic:'ZZZ9'},{av:'AV8pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'},{av:'AV7cLugarSectorEstadoSector',fld:'vCLUGARSECTORESTADOSECTOR',pic:''}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cLugarSectorId',fld:'vCLUGARSECTORID',pic:'ZZZ9'},{av:'AV8pEspectaculoId',fld:'vPESPECTACULOID',pic:'ZZZ9'},{av:'AV7cLugarSectorEstadoSector',fld:'vCLUGARSECTORESTADOSECTOR',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001Z2_A1EspectaculoId = new short[1] ;
         H001Z2_A41LugarSectorEstadoSector = new bool[] {false} ;
         H001Z2_A27LugarSectorId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00g1__default(),
            new Object[][] {
                new Object[] {
               H001Z2_A1EspectaculoId, H001Z2_A41LugarSectorEstadoSector, H001Z2_A27LugarSectorId
               }
               , new Object[] {
      ...
      private short AV8pEspectaculoId ;
      private short AV9pLugarSectorId ;
      private short wcpOAV8pEspectaculoId ;
      ...
      private string chkavClugarsectorestadosector_Internalname ;
      ...
      private bool AV7cLugarSectorEstadoSector ;
      private bool wbLoad ;
      private bool Rfr0gs ;
      private bool wbErr ;
      ...
      private GXCheckbox chkavClugarsectorestadosector ;
      private GXCheckbox chkLugarSectorEstadoSector ;
      private IDataStoreProvider pr_default ;
      private short[] H001Z2_A1EspectaculoId ;
      private bool[] H001Z2_A41LugarSectorEstadoSector ;
      private short[] H001Z2_A27LugarSectorId ;
   ...
   public class gx00g1__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H001Z2( IGxContext context ,
                                             bool AV7cLugarSectorEstadoSector ,
                                             bool A41LugarSectorEstadoSector ,
                                             short AV8pEspectaculoId ,
                                             short AV6cLugarSectorId ,
                                             short A1EspectaculoId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [EspectaculoId], [LugarSectorEstadoSector], [LugarSectorId]";
         sFromString = " FROM [EspectaculoLugarSector]";
         sOrderString = "";
         AddWhere(sWhereString, "([EspectaculoId] = @AV8pEspectaculoId and [LugarSectorId] >= @AV6cLugarSectorId)");
         if ( ! (false==AV7cLugarSectorEstadoSector) )
         {
            AddWhere(sWhereString, "([LugarSectorEstadoSector] >= @AV7cLugarSectorEstadoSector)");
         }
         else
         {
            GXv_int1[2] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001Z2(context, (bool)dynConstraints[0] , (bool)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H001Z3(context, (bool)dynConstraints[0] , (bool)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8pEspectaculoId",GXType.Int16,4,0) ,
          new ParDef("@AV6cLugarSectorId",GXType.Int16,4,0) ,
          new ParDef("@AV7cLugarSectorEstadoSector",GXType.Boolean,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001Z2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z2,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H001Z3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z3,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
