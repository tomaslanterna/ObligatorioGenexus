...
namespace GeneXus.Programs {
   public class lugarsectorwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6LugarId, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20228822345321", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RF1E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A4LugarId = H001E2_A4LugarId[0];
               AssignAttri(sPrefix, false, "A4LugarId", StringUtil.LTrimStr( (decimal)(A4LugarId), 4, 0));
               A30LugarSectorPrecio = H001E2_A30LugarSectorPrecio[0];
               A29LugarSectorCantidad = H001E2_A29LugarSectorCantidad[0];
               A28LugarSectorName = H001E2_A28LugarSectorName[0];
               A27LugarSectorId = H001E2_A27LugarSectorId[0];
               E121E2 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20228822345335", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("lugarsectorwc.js", "?20228822345335", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6LugarId',fld:'vLUGARID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E121E2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6LugarId',fld:'vLUGARID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6LugarId',fld:'vLUGARID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6LugarId',fld:'vLUGARID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6LugarId',fld:'vLUGARID',pic:'ZZZ9'},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         A28LugarSectorName = "";
         scmdbuf = "";
         H001E2_A4LugarId = new short[1] ;
         H001E2_A30LugarSectorPrecio = new short[1] ;
         H001E2_A29LugarSectorCantidad = new short[1] ;
         H001E2_A28LugarSectorName = new string[] {""} ;
         H001E2_A27LugarSectorId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.lugarsectorwc__default(),
            new Object[][] {
                new Object[] {
               H001E2_A4LugarId, H001E2_A30LugarSectorPrecio, H001E2_A29LugarSectorCantidad, H001E2_A28LugarSectorName, H001E2_A27LugarSectorId
               }
               , new Object[] {
      ...
      private short[] H001E2_A4LugarId ;
      private short[] H001E2_A30LugarSectorPrecio ;
      private short[] H001E2_A29LugarSectorCantidad ;
      private string[] H001E2_A28LugarSectorName ;
      private short[] H001E2_A27LugarSectorId ;
   ...
   public class lugarsectorwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001E2", "SELECT [LugarId], [LugarSectorPrecio], [LugarSectorCantidad], [LugarSectorName], [LugarSectorId] FROM [LugarSector] WHERE [LugarId] = @AV6LugarId ORDER BY [LugarId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001E2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001E3", "SELECT COUNT(*) FROM [LugarSector] WHERE [LugarId] = @AV6LugarId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001E3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
