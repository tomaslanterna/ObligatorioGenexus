...
namespace GeneXus.Programs {
   public class clientegeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A9ClienteId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281012272733", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("clientegeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A9ClienteId,4,0))}, new string[] {"ClienteId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA9ClienteId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA9ClienteId), 4, 0, ",", "")));
      }
      ...
      protected void WB0F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modificar", bttBtnupdate_Jsonclick, 7, "Modificar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110f1_client"+"'", TempTags, "", 2, "HLP_ClienteGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120f1_client"+"'", TempTags, "", 2, "HLP_ClienteGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtClienteName_Internalname, A10ClienteName, StringUtil.RTrim( context.localUtil.Format( A10ClienteName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClienteName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtClienteName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_ClienteGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisName_Internalname, A6PaisName, StringUtil.RTrim( context.localUtil.Format( A6PaisName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtPaisName_Link, "", "", "", edtPaisName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaisName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_ClienteGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP0F0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA9ClienteId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA9ClienteId"), ",", "."));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A9ClienteId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A9ClienteId", StringUtil.LTrimStr( (decimal)(A9ClienteId), 4, 0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A9ClienteId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A9ClienteId", StringUtil.LTrimStr( (decimal)(A9ClienteId), 4, 0));
         }
         wcpOA9ClienteId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA9ClienteId"), ",", "."));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            A9ClienteId = (short)(context.localUtil.CToN( cgiGet( sCtrlA9ClienteId), ",", "."));
            AssignAttri(sPrefix, false, "A9ClienteId", StringUtil.LTrimStr( (decimal)(A9ClienteId), 4, 0));
         }
         else
         {
            A9ClienteId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"A9ClienteId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A9ClienteId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A9ClienteId), 4, 0, ",", "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281012272746", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("clientegeneral.js", "?202281012272746", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A9ClienteId',fld:'CLIENTEID',pic:'ZZZ9'},{av:'A3PaisId',fld:'PAISID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E110F1',iparms:[{av:'A9ClienteId',fld:'CLIENTEID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E120F1',iparms:[{av:'A9ClienteId',fld:'CLIENTEID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000F2_A9ClienteId = new short[1] ;
         H000F2_A6PaisName = new string[] {""} ;
         H000F2_A3PaisId = new short[1] ;
         H000F2_A10ClienteName = new string[] {""} ;
         hsh = "";
         AV7TrnContext = new SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.clientegeneral__default(),
            new Object[][] {
                new Object[] {
               H000F2_A9ClienteId, H000F2_A6PaisName, H000F2_A3PaisId, H000F2_A10ClienteName
               }
            }
         );
         AV13Pgmname = "ClienteGeneral";
      ...
      private short[] H000F2_A9ClienteId ;
      private string[] H000F2_A6PaisName ;
      private short[] H000F2_A3PaisId ;
      private string[] H000F2_A10ClienteName ;
   ...
   public class clientegeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000F2", "SELECT T1.[ClienteId], T2.[PaisName], T1.[PaisId], T1.[ClienteName] FROM ([Cliente] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisId]) WHERE T1.[ClienteId] = @ClienteId ORDER BY T1.[ClienteId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
