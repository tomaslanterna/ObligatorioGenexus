...
namespace GeneXus.Programs {
   public class lugargeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A4LugarId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202281118495386", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("lugargeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A4LugarId,4,0))}, new string[] {"LugarId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GXUtil.WriteLogInfo("lugargeneral:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA4LugarId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA4LugarId), 4, 0, ",", "")));
      }
      ...
      protected void WB1D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modificar", bttBtnupdate_Jsonclick, 7, "Modificar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e111d1_client"+"'", TempTags, "", 2, "HLP_LugarGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e121d1_client"+"'", TempTags, "", 2, "HLP_LugarGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtLugarName_Internalname, A5LugarName, StringUtil.RTrim( context.localUtil.Format( A5LugarName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLugarName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtLugarName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_LugarGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisName_Internalname, A6PaisName, StringUtil.RTrim( context.localUtil.Format( A6PaisName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtPaisName_Link, "", "", "", edtPaisName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaisName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_LugarGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP1D0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA4LugarId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA4LugarId"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("lugargeneral:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A4LugarId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A4LugarId", StringUtil.LTrimStr( (decimal)(A4LugarId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA4LugarId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A4LugarId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A4LugarId", StringUtil.LTrimStr( (decimal)(A4LugarId), 4, 0));
         }
         wcpOA4LugarId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA4LugarId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( A4LugarId != wcpOA4LugarId ) ) )
         {
            setjustcreated();
         }
         wcpOA4LugarId = A4LugarId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA4LugarId = cgiGet( sPrefix+"A4LugarId_CTRL");
         if ( StringUtil.Len( sCtrlA4LugarId) > 0 )
         {
            A4LugarId = (short)(context.localUtil.CToN( cgiGet( sCtrlA4LugarId), ",", "."));
            AssignAttri(sPrefix, false, "A4LugarId", StringUtil.LTrimStr( (decimal)(A4LugarId), 4, 0));
         }
         else
         {
            A4LugarId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"A4LugarId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A4LugarId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A4LugarId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA4LugarId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A4LugarId_CTRL", StringUtil.RTrim( sCtrlA4LugarId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202281118495399", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("lugargeneral.js", "?20228111849540", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A4LugarId',fld:'LUGARID',pic:'ZZZ9'},{av:'A3PaisId',fld:'PAISID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E111D1',iparms:[{av:'A4LugarId',fld:'LUGARID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E121D1',iparms:[{av:'A4LugarId',fld:'LUGARID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001D2_A4LugarId = new short[1] ;
         H001D2_A6PaisName = new string[] {""} ;
         H001D2_A3PaisId = new short[1] ;
         H001D2_A5LugarName = new string[] {""} ;
         hsh = "";
         AV7TrnContext = new SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.lugargeneral__default(),
            new Object[][] {
                new Object[] {
               H001D2_A4LugarId, H001D2_A6PaisName, H001D2_A3PaisId, H001D2_A5LugarName
               }
            }
         );
         AV13Pgmname = "LugarGeneral";
      ...
      private short[] H001D2_A4LugarId ;
      private string[] H001D2_A6PaisName ;
      private short[] H001D2_A3PaisId ;
      private string[] H001D2_A5LugarName ;
   ...
   public class lugargeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001D2", "SELECT T1.[LugarId], T2.[PaisName], T1.[PaisId], T1.[LugarName] FROM ([Lugar] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisId]) WHERE T1.[LugarId] = @LugarId ORDER BY T1.[LugarId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
