...
namespace GeneXus.Programs {
   public class lugar_dataprovider : GXProcedure
   {
      ...
      {
         this.AV2ReturnValue = new GXBCCollection<SdtLugar>( context, "Lugar", "Obligatorio1v2") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBCCollection<SdtLugar> aP0_ReturnValue )
      {
         ...
         objlugar_dataprovider.AV2ReturnValue = new GXBCCollection<SdtLugar>( context, "Lugar", "Obligatorio1v2") ;
      ...
      {
         AV2ReturnValue = new GXBCCollection<SdtLugar>( context, "Lugar", "Obligatorio1v2");
         /* GeneXus formulas. */
         context.Gx_err = 0;
      }
